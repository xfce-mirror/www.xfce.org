...
<p>Xfce 4 online documentation is <a href="/documentation/">available online</a>. 
</p><br>
...
<ul class="submenu">
	...
	<a href="index.php?page=documentation&lang=en#startup">	startup notification
	</a> feature.</li>
...
<li>using the binaries provided for your OS, see the <a href="index.php?page=download&lang=en">download page</a> to find them.</li>
...
<ul class="submenu">
<!-- <li>xfce4&nbsp;&nbsp;&nbsp;&nbsp;<i>Use this module name to download all the modules at once</i></li><br> -->
...
or taskbar for a given application?</a><br>
...
<a name="iconbox">
<p><b>3. Is it possible to change the icon used by the iconbox or taskbar for a
given application?</b></p>
