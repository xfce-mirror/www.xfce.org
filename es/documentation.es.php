...
<ul class="submenu">
	...
	<a href="index.php?page=documentation&lang=es#startup">	startup notification
	</a> feature.</li>
...
<li>using the binaries provided for your OS, see the <a href="index.php?page=download&lang=es">download page</a> to find them.</li>
