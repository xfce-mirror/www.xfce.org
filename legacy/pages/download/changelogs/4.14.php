...
<ul>
  <li>Feature: Added support for desktop actions (Bug #11268)</li>
  <li>Feature: Added support for freedesktop Keyword item (Bug #10683)</li>
  <li>Feature: garcon-gtk: Add an option to edit launchers</li>
  <li>Feature: Support composite XDG_CURRENT_DESKTOP (Bug #14137)</li>
  <li>Builds: Make building garcon-gtk2 optional</li>
  <li>Builds: Remove extraneous libxfce4ui-1 check</li>
  <li>General: Replace hash table for application actions with a list</li>
  <li>Fix: Assertion 'GTK_IS_WIDGET (widget)' failed</li>
  <li>Fix: autogen.sh build warnings</li>
  <li>Fix: Decrement allocation counter on item unref (Bug #12700)</li>
  <li>Fix: Do not add a placeholder menu (Bug #11626)</li>
  <li>Fix: Documentation generation</li>
  <li>Fix: Drop libgarcon-2</li>
