...
<div id="slide">
	...
	<div id="slide-panel" style="background-image: url(<?php echo $static_media; ?>/slider/parole-mini.png);" alt="Panel" title="<?php E_('The Xfce Panel can be customized in numerous ways so it provides all the items you need right where you need them. It has three different display modes, transparency and a few dozen different plugins.') ?>">
