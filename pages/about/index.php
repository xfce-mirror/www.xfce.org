...
<p>
  <?php E_('Another priority of Xfce is adherence to standards, specifically those defined at <a href="https://freedesktop.org">freedesktop.org</a>.') ?>
</p>

<p>
  <?php E_('Xfce can be installed on several UNIX platforms. It is known to compile on Linux, NetBSD, FreeBSD, OpenBSD, Solaris, Cygwin and MacOS X, on x86, PPC, Sparc, Alpha...') ?>
</p>
