<?php $head['title'] = 'Xfce 4.12 Changelog'; ?>
...
<ul>
   ...
   <li>Fix some GTK_STOCK icon usages resulting in missing icons (bug #11608) (Jani V�limaa)</li>
   <li>plugins/thunar-wallpaper: Fix icon (Jani V�limaa)</li>
