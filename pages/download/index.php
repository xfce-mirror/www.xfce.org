...
<p>
  <?php E_('A lot of different distributions provide Xfce packages. Popular examples build around Xfce are <a href="https://xubuntu.org/">Xubuntu</a>, the <a href="https://spins.fedoraproject.org/xfce/">Fedora Xfce Spin</a> and <a href="http://www.zenwalk.org/">Zenwalk</a>, but there is a good chance your favorite distro provides packages as well.') ?>
</p>
<p>
