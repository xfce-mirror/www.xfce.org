		...
		'paragraphs' => array (
			...
			array(
				'<ul>',
					...
					'<li>'.R_('As always, <a href="https://docs.xfce.org/xfce/thunar/start">Thunar</a> - our file manager - received a lot of features and fixes. Among the visible changes are the completely reworked pathbar, support for larger thumbnails as well as support for a "folder.jpg" file altering the folder\'s icon (e.g. for music album covers). Power users will also notice the improved keyboard navigation (zooming, tab navigation).').'</li>',
					'<li>'.R_('Our thumbnailing service received a lot of fixes and support for the Fujifilm RAF format.').'</li>',
