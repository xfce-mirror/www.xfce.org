     ...
     'paragraphs' => array (
             ...
             array(
                     '<ul>',
                             ...
                             '<li>'.R_('The <a href="https://docs.xfce.org/xfce/xfce4-settings/start">settings manager</a> now has improved search and filter capabilities. Furthermore all settings dialogs now use window decorations drawn by Gtk (client side decorations).').'</li>',
