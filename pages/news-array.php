	...
	array ('title' => R_('Xfce 4.12 released'),
		...
		'paragraphs' => array (
			...
			'<ul>',
				...
				'<li>'.R_('The desktop has a new wallpaper settings dialog, per workspace wallpaper support, and better multi-monitor handling. It also supports displaying folder coverart and emblems on icons now.').'</li>',
