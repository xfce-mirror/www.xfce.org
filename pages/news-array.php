...
$news = array (
  array ('title' => R_('Xfce 4.16 released'),
     ...
     'paragraphs' => array (
             ...
             R_('During the 4.16 cycle, we migrated to Gitlab, added CI on all components, welcome new contributors (thank to the new Gitlab workflow !), and we are sponsored by Gandi, Fosshost and Scaleway for hosting'),
