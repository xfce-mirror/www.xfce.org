     ...
     'paragraphs' => array (
             ...
             array(
                     '<ul>',
                             ...
                             '<li>'.R_('Support for fractional scaling was added to the <a href="https://docs.xfce.org/xfce/xfce4-settings/display">display dialog</a>, along with highlighting the preferred mode of a display and adding aspect ratios next to resolutions. Falling back after misconfiguring the display layout has also been made more robust.').'</li>',
                             '<li>'.R_('A new tab in the "About Xfce" dialog shows the system´s basic information like CPU or GPU type. Furthermore the layout and visuals of the dialog were improved.').'</li>',
                             '<li>'.R_('The <a href="https://docs.xfce.org/xfce/xfce4-settings/start">settings manager</a> now has improved seach and filter capabilities. Furthermore all settings dialogs now use window decorations drawn by Gtk (client side decorations).').'</li>',
