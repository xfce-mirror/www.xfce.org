<h1>开发</h1>
<p>如果您正在寻找促进Xfce发展的途径，请考虑加入关于其中一个项目的<a href="../community/lists">邮件列表</a>和<a href="http://forum.xfce.org">论坛</a>。</p>
...
<tr>
		...
		<td width="33%" valign="top">
			...
			<p>Xfce被翻译成了许多不同的语言，如果您的语言的选项不存在，请帮助我们翻译Xfce。</p>
		</td>
		<td width="48" valign="top">
	...
	<tr>
		...
		<td width="33%" valign="top">
			...
			<p>Xfce Goodies项目包括与xfce桌面有关的额外软件和美工，但这不是官方发布的一部分。</p>
		</td>
		<td width="48" valign="top">
