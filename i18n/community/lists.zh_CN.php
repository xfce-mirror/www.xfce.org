...
<table width="99%" cellpadding="2">
    ...
    <tr>
		...
		<td bgcolor="#eeeeee">Xfce用户的讨论列表</td>
    </tr>
    <tr>
    ...
    <tr>
		...
		<td>Thunar文件管理器开发的邮件列表。</td>
    </tr>
</table>
<p></p>
<h1>搜索邮件列表</h1>
<p>
    您可以使用页面顶部的Google搜索来搜索邮件列表。在您搜索了之后，您可以通过点击“邮件列表”链接以使您的搜索更“精确”。
</p>
