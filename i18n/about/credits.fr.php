...
<table width="99%">
    ...
    <tr>
        ...
        <td width="60%" bgcolor="#eeeeee">Maintenance des serveurs</td>
    </tr>
    <tr>
        <td width="40%">Brian J. Tarricone [kelnos<?php at(); ?>xfce.org]</td>
        <td width="60%">Administrateur de Bugzilla</td>
    </tr>
    <tr>
...
<table width="99%">
    ...
    <tr>
        <td bgcolor="#eeeeee">Azerbaïdjanais [az]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Espagnol [es_MX]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Finlandais [fi]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Arménien [hy]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Japonais [ja]</td>
        <td bgcolor="#eeeeee">Daichi Kawahata [daichi<?php at(); ?>xfce.org]</td>
    </tr>
    <tr>
        <td>Coréen [ko]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Norvégien [nb_NO]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Portugais [pt_BR]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Tamoul [ta]</td>
