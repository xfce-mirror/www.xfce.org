...
<table width="99%">
    ...
    <tr>
        <td bgcolor="#eeeeee">アフリカーンス語 [af]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">アゼルバイジャン語 [az]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">ブルガリア語 [bg]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">カタロニア語 [ca]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">デンマーク語 [da]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">エスペラント [eo]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">スペイン語(メキシコ) [es_MX]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">グジャラート語 [gu]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">ヒンディー語 [hi]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">アルメニア語 [hy]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">ノルウェー語 [nb_NO]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">パンジャブ語 [pa]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">ポルトガル語(ブラジル) [pt_BR]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">ルーマニア語 [ro]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">スロバキア語 [sk]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">ウクライナ語 [uk]</td>
