...
<table width="99%">
    ...
    <tr>
        ...
        <td width="60%">Përgjegjës Desktopi, Lojtës Mediash</td>
    </tr>
    <tr>
        <td width="40%" bgcolor="#eeeeee">Danny Milosavljevic [dannym<?php at(); ?>xfce.org]</td>
        <td width="60%" bgcolor="#eeeeee">Kontroll Volumi</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="60%"><em>Webmaster</em> dhe <em>artwork</em></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="60%" bgcolor="#eeeeee">Përgjegjës Shtypësi, Zbatim për Shkrime CD-sh</td>
    </tr>
    <tr>
...
<table width="99%">
    ...
    <tr>
        <td bgcolor="#eeeeee">Arabisht [ar]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Anglisht [en_GB]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Spanjisht [es]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Hebraisht [he]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Italisht [it]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Holandisht [nl]</td>
