...
<table width="99%">
    ...
    <tr>
        <td>Bretonçe [be]</td>
        <td>Ales Nyakhaychyk [nab at mail.by]</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Shqip [sq]</td>
        <td>Besnik Bleta [besnik at programeshqip.org]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Suedisht [sv]</td>
        <td bgcolor="#eeeeee">Daniel Nylander [po at danielnylander.se], Magnus Berg [berg.magnus at bredband.net]</td>
    </tr>
    <tr>
        <td>Tamileze [ta]</td>
        <td>Dinesh Nadarajah [dinesh_list at sbcglobal.net]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Turqisht [tr]</td>
        <td bgcolor="#eeeeee">Er&Atilde;&sect;in Eker [erc.caldera at gmx.net]</td>
    </tr>
    <tr>
        <td>Ukrainisht [uk]</td>
        <td>Maxim V. Dziumanenko [mvd at mylinux.com.ua]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Vietnamezçe [vi]</td>
        <td bgcolor="#eeeeee">L&Atilde;&cent;m V&Auml;&copy;nh Ni&Atilde;&ordf;n [nienvl at yahoo.ca]</td>
    </tr>
    <tr>
        <td>Kinezçe [zh_CN]</td>
        <td>Huang Huan [unicon221 at gmail.com], Yongtao Yang [yongtao.yang at telia.com]</td>
    </tr>
    <tr>
        <tdbgcolor="#eeeeee">Kinezçe [zh_TW]</td>
        <tdbgcolor="#eeeeee">Hydonsingore Cia [hydonsingore at mail.educities.edu.tw]</td>
    </tr>
</table>
