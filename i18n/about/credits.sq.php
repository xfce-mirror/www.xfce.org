...
<table width="99%">
    ...
    <tr>
        ...
        <td width="60%" bgcolor="#eeeeee">Përgjegjës Shtypësi, zbatim shkrimesh CD-sh</td>
    </tr>
    <tr>
        <td width="40%">Micka&euml;l Graf [korbinus<?php at(); ?>xfce.org]</td>
        <td width="60%">Kalendar</td>
    </tr>
    <tr>
        <td width="40%" bgcolor="#eeeeee">Olivier Fourdan [fourdan<?php at(); ?>xfce.org]</td>
        <td width="60%" bgcolor="#eeeeee">Përgjegjës Dritaresh</td>
    </tr>
</table>
...
<table width="99%">
    ...
    <tr>
        ...
        <td width="60%" bgcolor="#eeeeee">Mirëmbajtje shërbyesi</td>
    </tr>
    <tr>
        <td width="40%">Brian J. Tarricone [kelnos<?php at(); ?>xfce.org]</td>
        <td width="60%">Administrues i Bugzilla-s</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Nick Schermer [nick<?php at(); ?>xfce.org]</td>
        <td bgcolor="#eeeeee">Hartimi Web</td>
    </tr>
</table>
...
<table width="99%">
    ...
    <tr>
        <td bgcolor="#eeeeee">Afrikaan [af]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Azerbaixhanisht [az]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Finlandisht [fi]</td>
        <td bgcolor="#eeeeee">Jari Rahkonen [jari.rahkonen<?php at(); ?>pp1.inet.fi]</td>
    </tr>
    <tr>
        <td>Frënge [fr]</td>
        <td>Collet Etienne [xanaxlnx<?php at(); ?>gmail.com], Gérald Barré [g.barre<?php at(); ?>free.fr], Maximilian Schleiss [maxschleiss<?php at(); ?>bluewin.ch], Olivier Fourdan [fourdan<?php at(); ?>xfce.org], Stephane Roy [sroy<?php at(); ?>j2n.net]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Gujaratase [gu]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Indisht [hi]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Armenisht [hy]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Japonisht [ja]</td>
        <td bgcolor="#eeeeee">Daichi Kawahata [daichi<?php at(); ?>xfce.org]</td>
    </tr>
    <tr>
        <td>Koreançe [ko]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Maratisht [mr]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Norvegjisht [nb_NO]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Punxhabe [pa]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Portugezçe [pt_BR]</td>
    ...
    <tr>
        <td>Portugezçe [pt_PT]</td>
        <td>Nuno Donato [nunodonato<?php at(); ?>zmail.pt]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Rumanisht [ro]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Slovakisht [sk]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Suedisht [sv]</td>
        <td bgcolor="#eeeeee">Daniel Nylander [po<?php at(); ?>danielnylander.se], Magnus Berg [berg.magnus<?php at(); ?>bredband.net]</td>
    </tr>
    <tr>
        <td>Tamileze [ta]</td>
        <td>Dinesh Nadarajah [dinesh_list<?php at(); ?>sbcglobal.net]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Turqisht [tr]</td>
        <td bgcolor="#eeeeee">Erçin EKER [erc.caldera<?php at(); ?>gmx.net]</td>
    </tr>
    <tr>
        <td>Ukrainisht [uk]</td>
        <td>Maxim V. Dziumanenko [mvd<?php at(); ?>mylinux.com.ua]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Vietnamezçe [vi]</td>
        <td bgcolor="#eeeeee">Lâm Vĩnh Niên [nienvl<?php at(); ?>yahoo.ca]</td>
    </tr>
    <tr>
        <td>Kinezçe [zh_CN]</td>
        <td>Huang Huan [unicon221<?php at(); ?>gmail.com], Yongtao Yang [yongtao.yang<?php at(); ?>telia.com]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Kinezçe [zh_TW]</td>
        <td bgcolor="#eeeeee">Cosmo Chene [cosmolax<?php at(); ?>gmail.com], Hydonsingore Cia [hydonsingore<?php at(); ?>mail.educities.edu.tw]</td>
    </tr>
</table>
