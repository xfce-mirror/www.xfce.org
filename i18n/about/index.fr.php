...
<p>Une autre priorité dans le développement de Xfce 4 est la conformité avec les standards, en particulier ceux définis par <a href="http://freedesktop.org" target="_blank">freedesktop.org</a>.</p>
<p>Xfce 4 peut être installé sur différentes systèmes UNIX. Des tests positifs ont été conclus sous Linux, NetBSD, FreeBSD, Solaris, Cygwin et MacOS X sur des machines x86, PPC, Sparc, Alpha...</p>
