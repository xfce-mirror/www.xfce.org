...
<table width="99%">
    ...
    <tr>
        ...
        <td width="60%" bgcolor="#eeeeee">Lautstärkeregler</td>
    </tr>
    <tr>
        <td width="40%">Eduard Roccatello [eduard<?php at(); ?>xfce.org]</td>
        <td width="60%">Programmsuche</td>
    </tr>
    <tr>
        <td width="40%" bgcolor="#eeeeee">Erik Harrison [erikharrison gmail.com]</td>
        <td width="60%" bgcolor="#eeeeee">Texteditor</td>
    </tr>
    <tr>
        <td width="40%">François Le Clainche [fleclainche<?php at(); ?>wanadoo.fr]</td>
        <td width="60%">Webmaster und Artwork</td>
    </tr>
    <tr>
        <td width="40%" bgcolor="#eeeeee">Giuseppe Torelli [colossus<?php at(); ?>xfce.org]</td>
        <td width="60%" bgcolor="#eeeeee">Archivierungsprogramm</td>
    </tr>
    <tr>
        <td width="40%">Jasper Huijsmans [jasper<?php at(); ?>xfce.org]</td>
        <td width="60%">Leiste</td>
    </tr>
    <tr>
        <td width="40%" bgcolor="#eeeeee">Jean-François Wauthy [pollux<?php at(); ?>xfce.org]</td>
        <td width="60%" bgcolor="#eeeeee">Druckerverwaltung, CD-Brennprogramm</td>
    </tr>
    <tr>
        <td width="40%">Mickaël Graf [korbinus<?php at(); ?>xfce.org]</td>
        <td width="60%">Kalender</td>
    </tr>
    <tr>
        <td width="40%" bgcolor="#eeeeee">Olivier Fourdan [fourdan<?php at(); ?>xfce.org]</td>
        <td width="60%" bgcolor="#eeeeee">Fensterverwaltung</td>
    </tr>
</table>
...
<table width="99%">
    ...
    <tr>
        ...
        <td width="60%" bgcolor="#eeeeee">Server-Instandhaltung</td>
    </tr>
    <tr>
        <td width="40%">Brian J. Tarricone [kelnos<?php at(); ?>xfce.org]</td>
        <td width="60%">Bugzilla-Administrator</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Nick Schermer [nick<?php at(); ?>xfce.org]</td>
        <td bgcolor="#eeeeee">Webdesigner</td>
    </tr>
</table>
...
<table width="99%">
    ...
    <tr>
        ...
        <td>Stephan Arts [stephan<?php at(); ?>xfce.org]</td>
    </tr>
    <tr>
    ...
    <tr>
    	<td>Biju Chacko [botsie<?php at(); ?>xfce.org]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Craig Betts [craig.betts<?php at(); ?>dfrc.nasa.gov]</td>
    </tr>
	<tr>
		<td>Edscott Wilson Garcia [edscott<?php at(); ?>xfce.org]</td>
	</tr>
    <tr>
...
<table width="99%">
    ...
    <tr>
        <td>Maximilian Schleiss [maxschleiss<?php at(); ?>solnet.ch]</td>
    </tr>
	<tr>
...
<table width="99%">
    ...
    <tr>
        <td bgcolor="#eeeeee">Arabisch [ar]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Katalanisch [ca]</td>
    ...
    <tr>
        <td>Tschechisch [cs]</td>
        <td>Michal Várady [miko.vaji<?php at(); ?>gmail.com]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Dänisch [da]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Englisch [en_GB]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Spanisch [es]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Baskisch [eu]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Französisch [fr]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Hebräisch [he]</td>
        <td bgcolor="#eeeeee">Dotan Kamber [kamberd<?php at(); ?>yahoo.com], Yuval Tanny [tanai<?php at(); ?>int.gov.il]</td>
    </tr>
    <tr>
        <td>Ungarisch [hu]</td>
        <td>SzervÃ¡c Attila [sas<?php at(); ?>321.hu]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Italienisch [it]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Kurdisch [ku]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Niederländisch [nl]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Slowakisch [sk]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Schwedisch [sv]</td>
