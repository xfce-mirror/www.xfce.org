...
<table width="99%">
    ...
    <tr>
        <td bgcolor="#eeeeee">Afrikaans [af]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Azerbaijani [az]</td>
    ...
    <tr>
        ...
        <td bgcolor="#eeeeee">Pau Rul路lan Ferragut [paurullan<?php at(); ?>bulma.net]</td>
    </tr>
    <tr>
        <td>Czech [cs]</td>
        <td>Alois Nespor [Alois.Nespor<?php at(); ?>seznam.cz], Michal V谩rady [miko.vaji<?php at(); ?>gmail.com]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Danish [da]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Spanish [es_MX]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Finnish [fi]</td>
        <td bgcolor="#eeeeee">Jari Rahkonen [jari.rahkonen<?php at(); ?>pp1.inet.fi]</td>
    </tr>
    <tr>
        <td>French [fr]</td>
        <td>Collet Etienne [xanaxlnx<?php at(); ?>gmail.com], G茅rald Barr茅 [g.barre<?php at(); ?>free.fr], Maximilian Schleiss [maxschleiss<?php at(); ?>bluewin.ch], Olivier Fourdan [fourdan<?php at(); ?>xfce.org], Stephane Roy [sroy<?php at(); ?>j2n.net]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Gujarati [gu]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Armenian [hy]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Japanese [ja]</td>
        <td bgcolor="#eeeeee">Daichi Kawahata [daichi<?php at(); ?>xfce.org]</td>
    </tr>
    <tr>
        <td>Korean [ko]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Kurdish [ku]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Marathi [mr]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Norwegian [nb_NO]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Punjabi [pa]</td>
        <td bgcolor="#eeeeee">Jaswinder Singh Phulewala [jaswinderphulewala<?php at(); ?>yahoo.com]</td>
    </tr>
    <tr>
        <td>Polish [pl]</td>
        <td>Marek Piechut [mco<?php at(); ?>o2.pl], Piotr Mali艅ski [admin<?php at(); ?>rk.edu.pl], Szymon Ka艂asz [szymon_maestro<?php at(); ?>gazeta.pl], Wit Wili艅ski [wit.wilinski<?php at(); ?>gmail.com]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Portuguese [pt_BR]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Romanian [ro]</td>
        <td bgcolor="#eeeeee">Mi艧u Moldovan [dumol<?php at(); ?>gnome.ro]</td>
    </tr>
    <tr>
        <td>Russian [ru]</td>
    ...
    <tr>
        <td bgcolor="#eeeeee">Slovak [sk]</td>
    ...
    <tr>
        <td>Turkish [tr]</td>
        <td>Er莽in EKER [erc.caldera<?php at(); ?>gmx.net]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">Ukrainian [uk]</td>
        <td bgcolor="#eeeeee">Maxim V. Dziumanenko [mvd<?php at(); ?>mylinux.com.ua]</td>
    </tr>
    <tr>
        <td>Vietnamese [vi]</td>
        <td>L芒m V末nh Ni锚n [nienvl<?php at(); ?>yahoo.ca]</td>
    </tr>
    <tr>
        <td bgcolor="#eeeeee">简体中文</td>
