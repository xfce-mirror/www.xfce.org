...
<p>
デスクトップアイコンは Xfce 4.4 から導入されましたが、多くの人々から (ラバーバンド法で) 複数アイコンの選択ができることを望まれました。
<b>Xfce 4.6</b> では、<b>Xfdesktop</b> マネージャがとうとうこの機能を実装しました。
これで複数アイコンの選択、移動、削除などが行えます。
</p>
...
<p>
<b>Xfce4 ミキサー</b>は一から書き直され、<a href="http://www.gstreamer.net/">GStreamer</a> を使うようになりました。これにより複数のサウンドシステムのサポートがより容易になり、ユーザインターフェイスはより洗練され、異なるサウンドカードの管理も行えるようになりました。
...
<p>
<b>Xfce 4.6</b> ではセッションマネージャが強化されました。セッションの起動が速くなり、設定ダイアログはシステムが認識するアプリケーションの管理を容易に行えるよう書き直されました。さらに、セッションマネージャは、クラッシュしたセッションアプリケーションが、デスクトップ、パネル、ウィンドウマネージャなどがない状態で残ってしまわないように、クラッシュした際に自動的に再起動します。
</p>
...
ログアウトダイアログには、コンピュータのサスペンドまたはハイバネートの 2 つのボタンが追加されています。
</p>
...
<p>
いつも通り、<b>Xfwm4</b> はこのリリースサイクルの間に、かなり熟成されました。
...
<p>
<b>マウス設定</b>ダイアログでは、コンピュータに接続されているマウスなどのポインティングデバイスごとに、ボタンオーダー、アクセラレーション、ダブルクリックスピード、マウスカーソルのテーマなどが設定できます。
</p>
...
<p>
<b>デスクトップの設定</b>ダイアログは、よりコンパクトになりました。
...
アプリケーションファインダはインストールされたアプリケーションを表示し (リストはキー入力により "オンザフライ" で更新されます)、簡単に検索および起動が行えます。
