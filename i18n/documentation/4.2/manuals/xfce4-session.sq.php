  ...
  <p><b>Figurë 1. <tt>xfce4-session</tt> parapëlqime të përgjithshme</b></p><img src="/images/documentation/4.2/xfsm-general.png" alt=
  "Shfaq skedën Të përgjitshme të dialogut të rregullimeve xfce4-session." />
  ...
  <dl>
    ...
    <dd>
      ...
      vetvetiu sesionin e çastit kur dilni prej tij. Nëse s'donitë
  ...
  <dl>
    ...
    <dd>
      ...
      KDE si pjesë e sesionit tuaj Xfce. Kjo do të rrisë dukshëm kohën
    ...
    <dd>
      ...
      <p>Administratorët e sistemeve mund të duan ta kativizojnë këtë
  ...
  <p>Majtas, dialogu shfaq një listë të tërë motorëve të instaluar.
  Përzgjidhni një motor, dhe do të shihni, në pastë, një paraparje dhe
  të dhëna rreth tij. Mund të klikoni butonin <b>Provë</b> për të parë
  një shfaqje të motorit të siglës së përzgjedhur.</p>

  <p><b><tt>xfce4-session</tt></b> ofron tre motorë teme Sigle
...
strehaime unëpërdoruesi=/usr/local/libexec/xfsm-shutdown-helper
  ...
  <p>Xfce për vendosjen e të dhënave të veta dhe kartela fomrësimi
  ...
  <dl>
    ...
    <dd>
      ...
      Si parazgjedhje, për këtë caktohet <tt>~/.config/</tt>.</p>
    </dd>

    <dt>${XDG_CONFIG_DIRS}</dt>

    <dd>
      <p>Një listë drejtorishë të sistemit që përmban të dhëna formësimi.
    ...
    <dd>
      ...
      të cialt mund të ndryshohen prej dialogut të rregullimeve.</p>
    </dd>

    <dt>${XDG_CONFIG_DIRS}/xfce4-session/xfce4-splash.rc</dt>

    <dd>
      <p>Ky ësht vendi i kartelës së formësimit që përfshin
...
Client3_PerScreen=False
  ...
  <p>Përgjegjëi i sesionit ofron mbulim të Mënyrës Kioskë, çka
...
CustomizeSecurity=NONE
  ...
  <dl>
    ...
    <dd>
      <p>I lejohet apo jo përdoruesit të përshtasë
      rregullime përputhshmëries (përputhje me KDE/Gnome)</p>
    </dd>
    ...
    <dd>
      <p>I lejohet apo jo përdoruesit të përshtasë të fikë (rinisë ose fikë
      plotësisht) sistemin. Nëse një përdoruesi nuk i lejohet kjo mundësitë
      për rinisje dhe fikje të plotë te dialogu i fikjes do të duken me ngjyrë gri.</p>
    </dd>
  </dl>
