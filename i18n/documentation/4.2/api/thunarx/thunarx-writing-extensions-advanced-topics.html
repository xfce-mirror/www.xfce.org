...
<p>
          ...
          <code class="function">thunar_extension_initialize()</code> function to <code class="literal">TRUE</code>, using the <a href="ThunarxProviderPlugin.html#thunarx-provider-plugin-set-resident"><code class="function">thunarx_provider_plugin_set_resident()</code></a>
          method.
        </p>
<div class="example">
<a name="id2554360"></a><p class="title"><b>Example&#160;2.&#160;Making an extension memory resident</b></p>
