...
<td valign="top">
<h2><span class="refentrytitle">ThunarxPreferencesProvider</span></h2>
<p>ThunarxPreferencesProvider &#8212; The interface to extensions that provide preferences</p>
</td>
<td valign="top" align="right"></td>
</tr></table></div>
<div class="refsect1" lang="en">
<a name="id2618725"></a><h2>Stability Level</h2>
...
GList*      <a href="ThunarxPreferencesProvider.html#thunarx-preferences-provider-get-actions">thunarx_preferences_provider_get_actions</a>
...
<div class="refsect1" lang="en">
<a name="id2619056"></a><h2>Object Hierarchy</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2619074"></a><h2>Prerequisites</h2>
<p>
ThunarxPreferencesProvider requires
 GObject.</p>
</div>
<div class="refsect1" lang="en">
<a name="id2619090"></a><h2>Description</h2>
<p>
...
<div class="example">
<a name="id2620240"></a><p class="title"><b>Example&#160;6.&#160;Preferences provider example</b></p>
...
<div class="refsect1" lang="en">
<a name="id2620252"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2620258"></a><h3>
<a name="ThunarxPreferencesProviderIface"></a>ThunarxPreferencesProviderIface</h3>
<a class="indexterm" name="id2620266"></a><pre class="programlisting">typedef struct {
...
<hr>
<div class="refsect2" lang="en">
<a name="id2620517"></a><h3>
<a name="ThunarxPreferencesProvider-struct"></a>ThunarxPreferencesProvider</h3>
<a class="indexterm" name="id2620528"></a><pre class="programlisting">typedef struct _ThunarxPreferencesProvider ThunarxPreferencesProvider;</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2620541"></a><h3>
<a name="thunarx-preferences-provider-get-actions"></a>thunarx_preferences_provider_get_actions ()</h3>
<a class="indexterm" name="id2620553"></a><pre class="programlisting">GList*      thunarx_preferences_provider_get_actions
                                            (<a href="ThunarxPreferencesProvider.html" title="ThunarxPreferencesProvider">ThunarxPreferencesProvider</a> *provider,
                                             GtkWidget *window);</pre>
<p>
...
<td align="right"><a accesskey="n" href="thunarx-using-extensions.html"><b>Part&#160;VI.&#160;Using Thunar extensions in applications&#160;&gt;&gt;</b></a></td>
</tr></table>
</body>
</html>
