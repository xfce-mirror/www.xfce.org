...
<p>Basic Types &#8212; Standard Thunar-VFS types, defined for ease-of-use and portability.</p>
</td>
<td valign="top" align="right"></td>
</tr></table></div>
<div class="refsect1" lang="en">
<a name="id2553026"></a><h2>Stability Level</h2>
...
<div class="refsect1" lang="en">
<a name="id2553496"></a><h2>Description</h2>
<p>
...
<div class="refsect1" lang="en">
<a name="id2553506"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2553511"></a><h3>
<a name="ThunarVfsFileType"></a>enum ThunarVfsFileType</h3>
<a class="indexterm" name="id2554612"></a><pre class="programlisting">typedef enum {
...
<td> The exact type of the file could not be
                                 determined.
</td>
</tr>
</tbody>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2601923"></a><h3>
<a name="ThunarVfsFileMode"></a>enum ThunarVfsFileMode</h3>
<a class="indexterm" name="id2601931"></a><pre class="programlisting">typedef enum { /*&lt; flags &gt;*/
...
<a class="indexterm" name="id2602243"></a><pre class="programlisting">typedef enum { /*&lt; flags &gt;*/
...
<tr>
<td>
<span class="term"><code class="literal">THUNAR_VFS_FILE_FLAGS_HIDDEN</code></span></td>
<td> The file should not be displayed normally,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2602330"></a><h3>
<a name="ThunarVfsFileDevice"></a>ThunarVfsFileDevice</h3>
<a class="indexterm" name="id2602339"></a><pre class="programlisting">typedef dev_t ThunarVfsFileDevice;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2602355"></a><h3>
<a name="ThunarVfsFileSize"></a>ThunarVfsFileSize</h3>
<a class="indexterm" name="id2602363"></a><pre class="programlisting">typedef gint64 ThunarVfsFileSize;
</pre>
<p>
...
<a class="indexterm" name="id2602387"></a><pre class="programlisting">typedef time_t ThunarVfsFileTime;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2602403"></a><h3>
<a name="ThunarVfsGroupId"></a>ThunarVfsGroupId</h3>
<a class="indexterm" name="id2602411"></a><pre class="programlisting">typedef gid_t ThunarVfsGroupId;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2602427"></a><h3>
<a name="ThunarVfsUserId"></a>ThunarVfsUserId</h3>
<a class="indexterm" name="id2602436"></a><pre class="programlisting">typedef uid_t ThunarVfsUserId;
</pre>
<p>
