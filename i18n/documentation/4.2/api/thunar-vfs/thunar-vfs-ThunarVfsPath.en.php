...
<a name="id2604037"></a><h2>Description</h2>
<p>

</p>
</div>
<div class="refsect1" lang="en">
<a name="id2604046"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2604052"></a><h3>
<a name="ThunarVfsPath"></a>ThunarVfsPath</h3>
<a class="indexterm" name="id2604060"></a><pre class="programlisting">typedef struct {
} ThunarVfsPath;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2604075"></a><h3>
<a name="thunar-vfs-path-new"></a>thunar_vfs_path_new ()</h3>
<a class="indexterm" name="id2604084"></a><pre class="programlisting"><a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a>* thunar_vfs_path_new          (const gchar *identifier,
                                             GError **error);</pre>
<p>
...
<a class="indexterm" name="id2604300"></a><pre class="programlisting"><a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a>* thunar_vfs_path_get_for_home (void);</pre>
<p>
...
<a class="indexterm" name="id2604373"></a><pre class="programlisting"><a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a>* thunar_vfs_path_get_for_root (void);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2604437"></a><h3>
<a name="thunar-vfs-path-ref"></a>thunar_vfs_path_ref ()</h3>
<a class="indexterm" name="id2604445"></a><pre class="programlisting"><a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a>* thunar_vfs_path_ref          (<a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2604592"></a><h3>
<a name="thunar-vfs-path-unref"></a>thunar_vfs_path_unref ()</h3>
<a class="indexterm" name="id2604600"></a><pre class="programlisting">void        thunar_vfs_path_unref           (<a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2604665"></a><h3>
<a name="thunar-vfs-path-hash"></a>thunar_vfs_path_hash ()</h3>
<a class="indexterm" name="id2604674"></a><pre class="programlisting">guint       thunar_vfs_path_hash            (gconstpointer path_ptr);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2604746"></a><h3>
<a name="thunar-vfs-path-equal"></a>thunar_vfs_path_equal ()</h3>
<a class="indexterm" name="id2604755"></a><pre class="programlisting">gboolean    thunar_vfs_path_equal           (gconstpointer path_ptr_a,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2604868"></a><h3>
<a name="thunar-vfs-path-is-home"></a>thunar_vfs_path_is_home ()</h3>
<a class="indexterm" name="id2604876"></a><pre class="programlisting">gboolean    thunar_vfs_path_is_home         (const <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2604955"></a><h3>
<a name="thunar-vfs-path-is-root"></a>thunar_vfs_path_is_root ()</h3>
<a class="indexterm" name="id2604964"></a><pre class="programlisting">gboolean    thunar_vfs_path_is_root         (const <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605037"></a><h3>
<a name="thunar-vfs-path-relative"></a>thunar_vfs_path_relative ()</h3>
<a class="indexterm" name="id2605046"></a><pre class="programlisting"><a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a>* thunar_vfs_path_relative     (<a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *parent,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605241"></a><h3>
<a name="thunar-vfs-path-get-name"></a>thunar_vfs_path_get_name ()</h3>
<a class="indexterm" name="id2605250"></a><pre class="programlisting">const gchar* thunar_vfs_path_get_name       (const <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605323"></a><h3>
<a name="thunar-vfs-path-get-parent"></a>thunar_vfs_path_get_parent ()</h3>
<a class="indexterm" name="id2605332"></a><pre class="programlisting"><a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a>* thunar_vfs_path_get_parent   (const <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605441"></a><h3>
<a name="thunar-vfs-path-dup-string"></a>thunar_vfs_path_dup_string ()</h3>
<a class="indexterm" name="id2605449"></a><pre class="programlisting">gchar*      thunar_vfs_path_dup_string      (const <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605539"></a><h3>
<a name="thunar-vfs-path-to-string"></a>thunar_vfs_path_to_string ()</h3>
<a class="indexterm" name="id2605547"></a><pre class="programlisting">gssize      thunar_vfs_path_to_string       (const <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path,
                                             gchar *buffer,
                                             gsize bufsize,
                                             GError **error);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605822"></a><h3>
<a name="thunar-vfs-path-dup-uri"></a>thunar_vfs_path_dup_uri ()</h3>
<a class="indexterm" name="id2605831"></a><pre class="programlisting">gchar*      thunar_vfs_path_dup_uri         (const <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605987"></a><h3>
<a name="thunar-vfs-path-to-uri"></a>thunar_vfs_path_to_uri ()</h3>
<a class="indexterm" name="id2605995"></a><pre class="programlisting">gssize      thunar_vfs_path_to_uri          (const <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path,
                                             gchar *buffer,
                                             gsize bufsize,
                                             GError **error);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606196"></a><h3>
<a name="thunar-vfs-path-list-from-string"></a>thunar_vfs_path_list_from_string ()</h3>
<a class="indexterm" name="id2606208"></a><pre class="programlisting">GList*      thunar_vfs_path_list_from_string
                                            (const gchar *uri_string,
                                             GError **error);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606345"></a><h3>
<a name="thunar-vfs-path-list-to-string"></a>thunar_vfs_path_list_to_string ()</h3>
<a class="indexterm" name="id2606355"></a><pre class="programlisting">gchar*      thunar_vfs_path_list_to_string  (GList *path_list);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606430"></a><h3>
<a name="thunar-vfs-path-list-append"></a>thunar_vfs_path_list_append ()</h3>
<a class="indexterm" name="id2606439"></a><pre class="programlisting">GList*      thunar_vfs_path_list_append     (GList *path_list,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606549"></a><h3>
<a name="thunar-vfs-path-list-prepend"></a>thunar_vfs_path_list_prepend ()</h3>
<a class="indexterm" name="id2606557"></a><pre class="programlisting">GList*      thunar_vfs_path_list_prepend    (GList *path_list,
                                             <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606669"></a><h3>
<a name="thunar-vfs-path-list-copy"></a>thunar_vfs_path_list_copy ()</h3>
<a class="indexterm" name="id2606678"></a><pre class="programlisting">GList*      thunar_vfs_path_list_copy       (GList *path_list);</pre>
<p>
...
<a class="indexterm" name="id2606904"></a><pre class="programlisting">void        thunar_vfs_path_list_free       (GList *path_list);</pre>
<p>
