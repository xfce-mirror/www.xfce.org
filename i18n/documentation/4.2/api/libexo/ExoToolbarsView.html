...
<td valign="top">
<h2><span class="refentrytitle">ExoToolbarsView</span></h2>
<p>ExoToolbarsView &#8212; A widget for displaying toolbars.</p>
</td>
...
<a name="id2616672"></a><h2>Object Hierarchy</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2616717"></a><h2>Implemented Interfaces</h2>
<p>
ExoToolbarsView implements
 AtkImplementorIface.</p>
</div>
<div class="refsect1" lang="en">
<a name="id2616732"></a><h2>Properties</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2616778"></a><h2>Signal Prototypes</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2616978"></a><h2>Description</h2>
<p>
...
<div class="refsect1" lang="en">
<a name="id2616995"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2617000"></a><h3>
<a name="ExoToolbarsView-struct"></a>ExoToolbarsView</h3>
<a class="indexterm" name="id2617009"></a><pre class="programlisting">typedef struct _ExoToolbarsView ExoToolbarsView;</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617024"></a><h3>
<a name="exo-toolbars-view-new"></a>exo_toolbars_view_new ()</h3>
<a class="indexterm" name="id2617032"></a><pre class="programlisting">GtkWidget*  exo_toolbars_view_new           (GtkUIManager *ui_manager);</pre>
<p>
Creates a new <a href="ExoToolbarsView.html" title="ExoToolbarsView"><span class="type">ExoToolbarsView</span></a>.</p>
<p>
...
<td> A newly created <a href="ExoToolbarsView.html" title="ExoToolbarsView"><span class="type">ExoToolbarsView</span></a>.
</td>
</tr>
</tbody>
</table></div>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617106"></a><h3>
<a name="exo-toolbars-view-new-with-model"></a>exo_toolbars_view_new_with_model ()</h3>
<a class="indexterm" name="id2617117"></a><pre class="programlisting">GtkWidget*  exo_toolbars_view_new_with_model
                                            (GtkUIManager *ui_manager,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617222"></a><h3>
<a name="exo-toolbars-view-get-editing"></a>exo_toolbars_view_get_editing ()</h3>
<a class="indexterm" name="id2617232"></a><pre class="programlisting">gboolean    exo_toolbars_view_get_editing   (<a href="ExoToolbarsView.html" title="ExoToolbarsView">ExoToolbarsView</a> *view);</pre>
<p>
</p>
<p>
...
<td> An <a href="ExoToolbarsView.html" title="ExoToolbarsView"><span class="type">ExoToolbarsView</span></a>.
</td>
</tr>
<tr>
<td>
<span class="term"><span class="emphasis"><em>Returns</em></span>&#160;:</span></td>
<td> <code class="literal">TRUE</code> if <em class="parameter"><code>view</code></em> is currently being edited, else <code class="literal">FALSE</code>.
</td>
</tr>
</tbody>
</table></div>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617309"></a><h3>
<a name="exo-toolbars-view-set-editing"></a>exo_toolbars_view_set_editing ()</h3>
<a class="indexterm" name="id2617319"></a><pre class="programlisting">void        exo_toolbars_view_set_editing   (<a href="ExoToolbarsView.html" title="ExoToolbarsView">ExoToolbarsView</a> *view,
                                             gboolean editing);</pre>
<p>
Sets wether <em class="parameter"><code>view</code></em> is currently being edited.</p>
<p>
...
<tr>
<td>
<span class="term"><em class="parameter"><code>editing</code></em>&#160;:</span></td>
<td> New editing mode.
</td>
</tr>
</tbody>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617395"></a><h3>
<a name="exo-toolbars-view-get-model"></a>exo_toolbars_view_get_model ()</h3>
<a class="indexterm" name="id2617403"></a><pre class="programlisting"><a href="ExoToolbarsModel.html" title="ExoToolbarsModel">ExoToolbarsModel</a>* exo_toolbars_view_get_model
                                            (<a href="ExoToolbarsView.html" title="ExoToolbarsView">ExoToolbarsView</a> *view);</pre>
<p>
...
<em class="parameter"><code>view</code></em> or <code class="literal">NULL</code> if <em class="parameter"><code>view</code></em> has no model.</p>
<p>
...
<td>
<span class="term"><span class="emphasis"><em>Returns</em></span>&#160;:</span></td>
<td> The <a href="ExoToolbarsModel.html" title="ExoToolbarsModel"><span class="type">ExoToolbarsModel</span></a> associated with <em class="parameter"><code>view</code></em>.
</td>
</tr>
</tbody>
</table></div>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617497"></a><h3>
<a name="exo-toolbars-view-set-model"></a>exo_toolbars_view_set_model ()</h3>
<a class="indexterm" name="id2617506"></a><pre class="programlisting">void        exo_toolbars_view_set_model     (<a href="ExoToolbarsView.html" title="ExoToolbarsView">ExoToolbarsView</a> *view,
                                             <a href="ExoToolbarsModel.html" title="ExoToolbarsModel">ExoToolbarsModel</a> *model);</pre>
<p>
</p>
<p>
...
<td>
<span class="term"><em class="parameter"><code>model</code></em>&#160;:</span></td>
<td> An <a href="ExoToolbarsModel.html" title="ExoToolbarsModel"><span class="type">ExoToolbarsModel</span></a> or <code class="literal">NULL</code>.
</td>
</tr>
</tbody>
</table></div>
...
<a name="exo-toolbars-view-get-ui-manager"></a>exo_toolbars_view_get_ui_manager ()</h3>
<a class="indexterm" name="id2617600"></a><pre class="programlisting">GtkUIManager* exo_toolbars_view_get_ui_manager
                                            (<a href="ExoToolbarsView.html" title="ExoToolbarsView">ExoToolbarsView</a> *view);</pre>
<p>
</p>
<p>
...
<td>
<span class="term"><span class="emphasis"><em>Returns</em></span>&#160;:</span></td>
<td> The <span class="type">GtkUIManager</span> associated with <em class="parameter"><code>view</code></em> or
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617746"></a><h3>
<a name="exo-toolbars-view-set-ui-manager"></a>exo_toolbars_view_set_ui_manager ()</h3>
<a class="indexterm" name="id2617826"></a><pre class="programlisting">void        exo_toolbars_view_set_ui_manager
                                            (<a href="ExoToolbarsView.html" title="ExoToolbarsView">ExoToolbarsView</a> *view,
                                             GtkUIManager *ui_manager);</pre>
<p>
</p>
<p>
...
<td>
<span class="term"><em class="parameter"><code>ui_manager</code></em>&#160;:</span></td>
<td> A <span class="type">GtkUIManager</span> or <code class="literal">NULL</code>.
</td>
</tr>
</tbody>
</table></div>
...
<div class="refsect1" lang="en">
<a name="id2617909"></a><h2>Properties</h2>
<div class="refsect2" lang="en">
<a name="id2617914"></a><h3>
<a name="ExoToolbarsView--editing"></a>The "<code class="literal">editing</code>" property</h3>
<pre class="programlisting">  "editing"              gboolean              : Read / Write</pre>
<p>
...
and make the requested changes to the model.</p>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617955"></a><h3>
<a name="ExoToolbarsView--model"></a>The "<code class="literal">model</code>" property</h3>
<pre class="programlisting">  "model"                <a href="ExoToolbarsModel.html" title="ExoToolbarsModel">ExoToolbarsModel</a>      : Read / Write</pre>
<p>
...
it will display the toolbars as described in the model.</p>
<p>
...
<a name="ExoToolbarsView--ui-manager"></a>The "<code class="literal">ui-manager</code>" property</h3>
<pre class="programlisting">  "ui-manager"           GtkUIManager          : Read / Write</pre>
<p>
...
<div class="refsect1" lang="en">
<a name="id2618074"></a><h2>Signals</h2>
<div class="refsect2" lang="en">
<a name="id2618080"></a><h3>
<a name="ExoToolbarsView-action-request"></a>The "action-request" signal</h3>
<pre class="programlisting">void        user_function                  (<a href="ExoToolbarsView.html" title="ExoToolbarsView">ExoToolbarsView</a> *view,
                                            gchar *arg1,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2618160"></a><h3>
<a name="ExoToolbarsView-customize"></a>The "customize" signal</h3>
<pre class="programlisting">void        user_function                  (<a href="ExoToolbarsView.html" title="ExoToolbarsView">ExoToolbarsView</a> *view,
                                            gpointer user_data);</pre>
<p>
...
connected a handler to this signal.</p>
<p>
...
<td align="left"><a accesskey="p" href="ExoToolbarsEditorDialog.html"><b>&lt;&lt;&#160;ExoToolbarsEditorDialog</b></a></td>
<td align="right"><a accesskey="n" href="exo-widgets.html"><b>Part&#160;III.&#160;Additional widgets&#160;&gt;&gt;</b></a></td>
</tr></table>
</body>
</html>
