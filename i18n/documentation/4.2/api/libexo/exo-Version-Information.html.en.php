...
<link rel="prev" href="exo-miscelleanous.html" title="Part&#160;V.&#160;Miscelleanous">
...
<a name="id2661336"></a><h2>Stability Level</h2>
...
const gchar* <a href="exo-Version-Information.html#exo-check-version">exo_check_version</a>              (guint required_major,
...
<div class="refsect1" lang="en">
<a name="id2662172"></a><h2>Description</h2>
<p>
...
<div class="refsect1" lang="en">
<a name="id2662182"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2662187"></a><h3>
<a name="exo-major-version"></a>exo_major_version</h3>
<a class="indexterm" name="id2663152"></a><pre class="programlisting">extern const guint exo_major_version;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2663176"></a><h3>
<a name="exo-minor-version"></a>exo_minor_version</h3>
<a class="indexterm" name="id2663185"></a><pre class="programlisting">extern const guint exo_minor_version;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2663209"></a><h3>
<a name="exo-micro-version"></a>exo_micro_version</h3>
<a class="indexterm" name="id2663218"></a><pre class="programlisting">extern const guint exo_micro_version;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2663310"></a><h3>
<a name="exo-check-version"></a>exo_check_version ()</h3>
<a class="indexterm" name="id2663319"></a><pre class="programlisting">const gchar* exo_check_version              (guint required_major,
                                             guint required_minor,
                                             guint required_micro);</pre>
<p>
Checks that the <code class="systemitem">exo</code> library
in use is compatible with the given version. Generally you would pass in
the constants <a href="exo-Version-Information.html#EXO-MAJOR-VERSION:CAPS"><span class="type">EXO_MAJOR_VERSION</span></a>, <a href="exo-Version-Information.html#EXO-MINOR-VERSION:CAPS"><span class="type">EXO_MINOR_VERSION</span></a> and <a href="exo-Version-Information.html#EXO-MICRO-VERSION:CAPS"><span class="type">EXO_MICRO_VERSION</span></a>
...
<div class="example">
<a name="id2663397"></a><p class="title"><b>Example&#160;2.&#160;Checking the runtime version of the exo library</b></p>
...
<a name="EXO-MAJOR-VERSION:CAPS"></a>EXO_MAJOR_VERSION</h3>
<a class="indexterm" name="id2663483"></a><pre class="programlisting">#define EXO_MAJOR_VERSION 0
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2663504"></a><h3>
<a name="EXO-MINOR-VERSION:CAPS"></a>EXO_MINOR_VERSION</h3>
<a class="indexterm" name="id2663512"></a><pre class="programlisting">#define EXO_MINOR_VERSION 3
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2663532"></a><h3>
<a name="EXO-MICRO-VERSION:CAPS"></a>EXO_MICRO_VERSION</h3>
<a class="indexterm" name="id2663541"></a><pre class="programlisting">#define EXO_MICRO_VERSION 1
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2663561"></a><h3>
<a name="EXO-CHECK-VERSION:CAPS"></a>EXO_CHECK_VERSION()</h3>
<a class="indexterm" name="id2663570"></a><pre class="programlisting">#define     EXO_CHECK_VERSION(major,minor,micro)</pre>
<p>
...
<td>major version (e.g. 0 for version 0.1.3)
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>minor</code></em>&#160;:</span></td>
<td>minor version (e.g. 1 for version 0.1.3)
</td>
</tr>
<tr>
<td>
...
<td align="left"><a accesskey="p" href="exo-miscelleanous.html"><b>&lt;&lt;&#160;Part&#160;V.&#160;Miscelleanous</b></a></td>
<td align="right"><a accesskey="n" href="exo-Binding-Properties-Functions.html"><b>Binding Properties Functions&#160;&gt;&gt;</b></a></td>
</tr></table>
</body>
</html>
