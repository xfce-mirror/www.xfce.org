...
<td valign="top">
<h2><span class="refentrytitle">Binding Properties Functions</span></h2>
...
<a name="id2664830"></a><h2>Description</h2>
<p>
...
<div class="example">
<a name="id2664859"></a><p class="title"><b>Example&#160;3.&#160;Connecting a <span class="structname">GtkCheckButton</span> and a
...
<div class="refsect1" lang="en">
<a name="id2664889"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2664894"></a><h3>
<a name="ExoBinding"></a>ExoBinding</h3>
<a class="indexterm" name="id2664903"></a><pre class="programlisting">typedef struct {
} ExoBinding;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2664917"></a><h3>
<a name="ExoMutualBinding"></a>ExoMutualBinding</h3>
<a class="indexterm" name="id2664994"></a><pre class="programlisting">typedef struct {
} ExoMutualBinding;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2665009"></a><h3>
<a name="ExoBindingTransform"></a>ExoBindingTransform ()</h3>
<a class="indexterm" name="id2665017"></a><pre class="programlisting">gboolean    (*ExoBindingTransform)          (const GValue *src_value,
                                             GValue *dst_value,
...
<tr>
<td>
<span class="term"><em class="parameter"><code>dst_value</code></em>&#160;:</span></td>
...
<td>
<code class="literal">FALSE</code> if transformation failed, else <code class="literal">TRUE</code>.
...
<hr>
<div class="refsect2" lang="en">
<a name="id2665147"></a><h3>
<a name="exo-binding-new"></a>exo_binding_new ()</h3>
<a class="indexterm" name="id2665156"></a><pre class="programlisting"><a href="exo-Binding-Properties-Functions.html#ExoBinding">ExoBinding</a>* exo_binding_new                 (GObject *src_object,
                                             const gchar *src_property,
                                             GObject *dst_object,
                                             const gchar *dst_property);</pre>
<p>
...
value of <em class="parameter"><code>src_property</code></em>.</p>
<p>
...
<tr>
<td>
<span class="term"><em class="parameter"><code>src_object</code></em>&#160;:</span></td>
<td> The source <span class="type">GObject</span>.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>src_property</code></em>&#160;:</span></td>
<td> The name of the property to bind from.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>dst_object</code></em>&#160;:</span></td>
<td> The destination <span class="type">GObject</span>.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>dst_property</code></em>&#160;:</span></td>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2665316"></a><h3>
<a name="exo-binding-new-full"></a>exo_binding_new_full ()</h3>
<a class="indexterm" name="id2665324"></a><pre class="programlisting"><a href="exo-Binding-Properties-Functions.html#ExoBinding">ExoBinding</a>* exo_binding_new_full            (GObject *src_object,
                                             const gchar *src_property,
                                             GObject *dst_object,
                                             const gchar *dst_property,
                                             <a href="exo-Binding-Properties-Functions.html#ExoBindingTransform">ExoBindingTransform</a> transform,
...
<tr>
<td>
<span class="term"><em class="parameter"><code>transform</code></em>&#160;:</span></td>
<td> Transformation function or <code class="literal">NULL</code>.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>destroy_notify</code></em>&#160;:</span></td>
<td> Callback function that is called on
...
<hr>
<div class="refsect2" lang="en">
<a name="id2665627"></a><h3>
<a name="exo-binding-new-with-negation"></a>exo_binding_new_with_negation ()</h3>
<a class="indexterm" name="id2665637"></a><pre class="programlisting"><a href="exo-Binding-Properties-Functions.html#ExoBinding">ExoBinding</a>* exo_binding_new_with_negation   (GObject *src_object,
                                             const gchar *src_property,
                                             GObject *dst_object,
                                             const gchar *dst_property);</pre>
<p>
Convenience function for binding with boolean negation of value.</p>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2665830"></a><h3>
<a name="exo-binding-unbind"></a>exo_binding_unbind ()</h3>
<a class="indexterm" name="id2665838"></a><pre class="programlisting">void        exo_binding_unbind              (<a href="exo-Binding-Properties-Functions.html#ExoBinding">ExoBinding</a> *binding);</pre>
<p>
...
was specified when <em class="parameter"><code>binding</code></em> was created.</p>
<p>
...
<tbody><tr>
<td>
<span class="term"><em class="parameter"><code>binding</code></em>&#160;:</span></td>
<td> An <a href="exo-Binding-Properties-Functions.html#ExoBinding"><span class="type">ExoBinding</span></a> to unbind.
</td>
</tr></tbody>
</table></div>
</div>
<hr>
<div class="refsect2" lang="en">
<a name="id2665905"></a><h3>
<a name="exo-mutual-binding-new"></a>exo_mutual_binding_new ()</h3>
<a class="indexterm" name="id2665913"></a><pre class="programlisting"><a href="exo-Binding-Properties-Functions.html#ExoMutualBinding">ExoMutualBinding</a>* exo_mutual_binding_new    (GObject *object1,
                                             const gchar *property1,
                                             GObject *object2,
                                             const gchar *property2);</pre>
<p>
...
of <em class="parameter"><code>property1</code></em>.</p>
<p>
...
<tr>
<td>
<span class="term"><em class="parameter"><code>object1</code></em>&#160;:</span></td>
<td> The first <span class="type">GObject</span>.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>property1</code></em>&#160;:</span></td>
<td> The first property to bind.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>object2</code></em>&#160;:</span></td>
<td> The second <span class="type">GObject</span>.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>property2</code></em>&#160;:</span></td>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2666052"></a><h3>
<a name="exo-mutual-binding-new-full"></a>exo_mutual_binding_new_full ()</h3>
<a class="indexterm" name="id2666060"></a><pre class="programlisting"><a href="exo-Binding-Properties-Functions.html#ExoMutualBinding">ExoMutualBinding</a>* exo_mutual_binding_new_full
                                            (GObject *object1,
                                             const gchar *property1,
                                             GObject *object2,
                                             const gchar *property2,
...
<tr>
<td>
<span class="term"><em class="parameter"><code>reverse_transform</code></em>&#160;:</span></td>
<td> The inverse transformation function or <code class="literal">NULL</code>.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="parameter"><code>destroy_notify</code></em>&#160;:</span></td>
<td> Callback function called on disconnection with
...
<hr>
<div class="refsect2" lang="en">
<a name="id2666329"></a><h3>
<a name="exo-mutual-binding-new-with-negation"></a>exo_mutual_binding_new_with_negation ()</h3>
<a class="indexterm" name="id2666341"></a><pre class="programlisting"><a href="exo-Binding-Properties-Functions.html#ExoMutualBinding">ExoMutualBinding</a>* exo_mutual_binding_new_with_negation
                                            (GObject *object1,
                                             const gchar *property1,
                                             GObject *object2,
                                             const gchar *property2);</pre>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2666466"></a><h3>
<a name="exo-mutual-binding-unbind"></a>exo_mutual_binding_unbind ()</h3>
<a class="indexterm" name="id2666474"></a><pre class="programlisting">void        exo_mutual_binding_unbind       (<a href="exo-Binding-Properties-Functions.html#ExoMutualBinding">ExoMutualBinding</a> *binding);</pre>
<p>
Disconnects the binding between two properties. Should be
rarely used by applications.
</p>
...
<td>
<span class="term"><em class="parameter"><code>binding</code></em>&#160;:</span></td>
<td> An <a href="exo-Binding-Properties-Functions.html#ExoMutualBinding"><span class="type">ExoMutualBinding</span></a> to unbind.
</td>
</tr></tbody>
</table></div>
</div>
...
<div class="refsect1" lang="en">
<a name="id2666610"></a><h2>See Also</h2>
<p>
...
<td align="left"><a accesskey="p" href="exo-Version-Information.html"><b>&lt;&lt;&#160;Version Information</b></a></td>
<td align="right"><a accesskey="n" href="exo-Executing-Applications.html"><b>Executing Applications&#160;&gt;&gt;</b></a></td>
</tr></table>
</body>
</html>
