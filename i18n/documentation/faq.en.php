...
<h3 id="astarting">Getting started</h3>
<ul>
	<li><a href="#a1-1">What is &quot;Xfce&quot; and why should I use it?</a></li>
	<li><a href="#a1-2">How is Xfce pronounced and what does it mean? </a></li>
	<li><a href="#a1-3">What does the logo symbolize?</a></li>
	<li><a href="#a1-4">On what platforms does Xfce currently run? </a></li>
</ul>

<h3 id="ainstallation">Installation</h3>
<ul>
	<li><a href="#a2-1">How do I install Xfce? </a></li>
	<li><a href="#a2-2">What is the &quot;use startup notification&quot; option?</a></li>
	<li><a href="#a2-3">The graphical installer fails with &quot;C++ preprocessor fails sanity check&quot;</a></li>
	<li><a href="#a2-4">The graphical installer fails with &quot;Unable to connect to Xserver&quot;</a></li>
	<li><a href="#a2-5">Is it possible to use Xfce with DM's? </a></li>
	<li><a href="#a2-6">Is it possible to start Xfce when I login on the console? </a></li>
</ul>

<h3 id="ausage">Usage</h3>
<ul>
	<li><a href="#a3-1">How do I start Xfce. </a></li>
	<li><a href="#a3-2">I want to use Xfce in a corporate environment and don't let users to modify their menu.</a></li>
	<li><a href="#a3-3">How do I display a list of all windows?</a></li>
	<li><a href="#a3-4">How do I disable the taskbar in Xfce 4.2?</a></li>
	<li><a href="#a3-5">When I start Xfce a dialog pops up saying &quot;Could not look up internet address for&quot; ... </a></li>
	<li><a href="#a3-6">How do I get numlock to start on login?</a></li>
	<li><a href="#a3-7">Is it possible to use Media keys in the Shortcut Editor? </a></li>
	<li><a href="#a3-8">I'm unable to shutdown or restart my computer when running Xfce. </a></li>
	<li><a href="#a3-9">The left-click to get the menu on the title bar menu button seems a little slow. How do I change that?</a></li>
</ul>

<h3 id="aappearance">Visual Appearance</h3>
<ul>
	<li><a href="#a4-1">How do I set the panel layer in Xfce 4.2 and 4.4?</a></li>
	<li><a href="#a4-2">How do I enable panel transparency and windows shadows? </a></li>
	<li><a href="#a4-3">My Xfce Desktop doesn't has any shortcut icons, why? </a></li>
	<li><a href="#a4-4">The gtk-xfce-engine themes do not appear in the &quot;user interface&quot; settings dialog. </a></li>
	<li><a href="#a4-5">Is it possible to change the icon used by the iconbox or taskbar for a given application?</a></li>
	<li><a href="#a4-6">I've installed a plugin for the panel, but the indicators don't use different colors. What can I do?</a></li>
</ul>

<h3 id="adevelopment">Development</h3>
<ul>
...
<dl>
	...
	<dt id="a1-2">How is Xfce pronounced and what does it mean?</dt>
	...
	<dt id="a1-3">What does the logo symbolize?</dt>
...
<dl>
	...
	<dt id="a2-2">What is the &quot;use startup notification&quot; option?</dt>
	...
	<dt id="a2-3">The graphical installer fails with &quot;C++ preprocessor fails sanity check&quot;</dt>
	...
	<dt id="a2-4">The graphical installer fails with &quot;Unable to connect to Xserver&quot;</dt>
...
<h2>Usage</h2>
<dl>
	<dt id="a3-1">How do I start Xfce.</dt>
	...
	<dt id="a3-2">I want to use Xfce in a corporate environment and don't let users to modify their menu.</dt>
	<dd>Use kiosk mode (see panel and xfce4-session docs).</dd>
	
	<dt id="a3-3">How do I display a list of all windows?</dt>
...
<dl>
	...
	<dt id="a4-3">My Xfce Desktop doesn't has any shortcut icons, why?</dt>
	<dd>&nbsp;</dd>
	
	<dt id="a4-4">The gtk-xfce-engine themes do not appear in the &quot;user interface&quot; settings dialog</dt>
	...
	<dt id="a4-5">Is it possible to change the icon used by the iconbox or taskbar for a given application?</dt>
