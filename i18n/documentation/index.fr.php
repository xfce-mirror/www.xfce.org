...
<table width="99%">
  <tr>
    ...
    <td width="49%" valign="top">
      ...
      <p>Vous pouvez trouver les questions les plus fréquemment posées sur Xfce dans le <a href="http://wiki.xfce.org/faq" target="_blank">wiki Xfce</a>.</p>
      <h2><a href="/documentation/requirements">Dépendances</a></h2>
          <p>Une liste détaillée des <a href="/documentation/requirements">dépendances</a> de Xfce.</p>
