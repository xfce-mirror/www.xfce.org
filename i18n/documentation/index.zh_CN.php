<h1>文档</h1>
<p>此页为用户和开发者提供了大部分Xfce文档。</p>
<table width="99%">
  <tr>
    <td width="49%" valign="top">
      <h2><a href="/documentation/4.4/userguide/">用户指南</a></h2>
      <p>非常抱歉，我们(<a href="/development/">暂时</a>)还没有4.4的文档。你可以搜索<a href="/documentation/4.2/">4.2文档</a>，访问<a href="http://forum.xfce.org" target="_blank">Xfce论坛</a>或者使用<a href="/community/lists">邮件列表</a>来解决你的问题。</p>
      ...
      <ul>
        ...
        <li><a href="/documentation/api/libxfprint/">libxfprint</a> (<a href="/documentation/api/libxfprint-docs.tar.gz">tarball</a>)</li>
          ...
          <ul>
            <li><a href="/documentation/4.2/">4.2文档</a></li>
            <li><a href="/documentation/4.0/">4.0文档</a></li>
    </ul></td>
	<td width="2%">&nbsp;</td>
    <td width="49%" valign="top">
