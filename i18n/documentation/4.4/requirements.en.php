...
<p>All packages (except xfce4-dev-tools) depend on both gtk+&nbsp;&gt;=&nbsp;2.6 and glib&nbsp;&gt;=&nbsp;2.6.4.
The order in the dependency table is also the recommended build order.<br />
It's also recommended to build all Xfce components from the same release version.</p>
