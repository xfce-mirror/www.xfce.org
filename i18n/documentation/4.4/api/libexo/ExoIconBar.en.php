...
<link rel="prev" href="ExoEllipsizedLabel.html" title="ExoEllipsizedLabel">
...
<td><a accesskey="p" href="ExoEllipsizedLabel.html"><img src="left.png" width="24" height="24" border="0" alt="Prev"></a></td>
...
<td valign="top">
<h2><span class="refentrytitle">ExoIconBar</span></h2>
...
<a name="id2622400"></a><h2>Object Hierarchy</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2622434"></a><h2>Implemented Interfaces</h2>
<p>
ExoIconBar implements
 AtkImplementorIface.</p>
</div>
<div class="refsect1" lang="en">
<a name="id2622449"></a><h2>Properties</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2622587"></a><h2>Style Properties</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2622749"></a><h2>Signal Prototypes</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2622856"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2622861"></a><h3>
<a name="ExoIconBar-struct"></a>ExoIconBar</h3>
<a class="indexterm" name="id2622870"></a><pre class="programlisting">typedef struct _ExoIconBar ExoIconBar;</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2621861"></a><h3>
<a name="exo-icon-bar-new"></a>exo_icon_bar_new ()</h3>
<a class="indexterm" name="id2621869"></a><pre class="programlisting">GtkWidget*  exo_icon_bar_new                (void);</pre>
<p>
</p>
<p>
...
<td> a newly allocated <a href="ExoIconBar.html" title="ExoIconBar"><span class="type">ExoIconBar</span></a>.
</td>
</tr></tbody>
</table></div>
</div>
...
<a name="exo-icon-bar-new-with-model"></a>exo_icon_bar_new_with_model ()</h3>
<a class="indexterm" name="id2621921"></a><pre class="programlisting">GtkWidget*  exo_icon_bar_new_with_model     (GtkTreeModel *model);</pre>
<p>
...
<td>
<span class="term"><span class="emphasis"><em>Returns</em></span>&#160;:</span></td>
<td> a newly allocated <a href="ExoIconBar.html" title="ExoIconBar"><span class="type">ExoIconBar</span></a>, which
...
<hr>
<div class="refsect2" lang="en">
<a name="id2622006"></a><h3>
<a name="exo-icon-bar-get-model"></a>exo_icon_bar_get_model ()</h3>
<a class="indexterm" name="id2622014"></a><pre class="programlisting">GtkTreeModel* exo_icon_bar_get_model        (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar);</pre>
<p>
...
<tr>
<td>
<span class="term"><em class="parameter"><code>icon_bar</code></em>&#160;:</span></td>
<td> A <a href="ExoIconBar.html" title="ExoIconBar"><span class="type">ExoIconBar</span></a>.
</td>
</tr>
<tr>
<td>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2623329"></a><h3>
<a name="exo-icon-bar-set-model"></a>exo_icon_bar_set_model ()</h3>
<a class="indexterm" name="id2623337"></a><pre class="programlisting">void        exo_icon_bar_set_model          (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
...
<a name="exo-icon-bar-get-pixbuf-column"></a>exo_icon_bar_get_pixbuf_column ()</h3>
<a class="indexterm" name="id2623521"></a><pre class="programlisting">gint        exo_icon_bar_get_pixbuf_column  (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar);</pre>
<p>
...
<td>
<span class="term"><em class="parameter"><code>icon_bar</code></em>&#160;:</span></td>
<td> An <a href="ExoIconBar.html" title="ExoIconBar"><span class="type">ExoIconBar</span></a>.
</td>
</tr>
<tr>
<td>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2623657"></a><h3>
<a name="exo-icon-bar-set-pixbuf-column"></a>exo_icon_bar_set_pixbuf_column ()</h3>
<a class="indexterm" name="id2623667"></a><pre class="programlisting">void        exo_icon_bar_set_pixbuf_column  (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
                                             gint column);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2623757"></a><h3>
<a name="exo-icon-bar-get-text-column"></a>exo_icon_bar_get_text_column ()</h3>
<a class="indexterm" name="id2623766"></a><pre class="programlisting">gint        exo_icon_bar_get_text_column    (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar);</pre>
<p>
...
<a name="exo-icon-bar-set-text-column"></a>exo_icon_bar_set_text_column ()</h3>
<a class="indexterm" name="id2623843"></a><pre class="programlisting">void        exo_icon_bar_set_text_column    (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
                                             gint column);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2623937"></a><h3>
<a name="exo-icon-bar-get-orientation"></a>exo_icon_bar_get_orientation ()</h3>
<a class="indexterm" name="id2623945"></a><pre class="programlisting">GtkOrientation exo_icon_bar_get_orientation (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar);</pre>
<p>
Retrieves the current orientation of the toolbar. See
<a href="ExoIconBar.html#exo-icon-bar-set-orientation"><code class="function">exo_icon_bar_set_orientation()</code></a>.</p>
<p>
...
<a name="exo-icon-bar-set-orientation"></a>exo_icon_bar_set_orientation ()</h3>
<a class="indexterm" name="id2624028"></a><pre class="programlisting">void        exo_icon_bar_set_orientation    (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2624112"></a><h3>
<a name="exo-icon-bar-get-active"></a>exo_icon_bar_get_active ()</h3>
<a class="indexterm" name="id2624120"></a><pre class="programlisting">gint        exo_icon_bar_get_active         (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar);</pre>
<p>
...
<a name="exo-icon-bar-set-active"></a>exo_icon_bar_set_active ()</h3>
<a class="indexterm" name="id2624189"></a><pre class="programlisting">void        exo_icon_bar_set_active         (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
                                             gint index);</pre>
<p>
...
<a name="exo-icon-bar-get-active-iter"></a>exo_icon_bar_get_active_iter ()</h3>
<a class="indexterm" name="id2624347"></a><pre class="programlisting">gboolean    exo_icon_bar_get_active_iter    (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2624451"></a><h3>
<a name="exo-icon-bar-set-active-iter"></a>exo_icon_bar_set_active_iter ()</h3>
<a class="indexterm" name="id2624459"></a><pre class="programlisting">void        exo_icon_bar_set_active_iter    (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
                                             GtkTreeIter *iter);</pre>
<p>
...
<div class="refsect1" lang="en">
<a name="id2624565"></a><h2>Properties</h2>
<div class="refsect2" lang="en">
<a name="id2624570"></a><h3>
<a name="ExoIconBar--active"></a>The "<code class="literal">active</code>" property</h3>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2624685"></a><h3>
<a name="ExoIconBar--model"></a>The "<code class="literal">model</code>" property</h3>
...
<a name="ExoIconBar--orientation"></a>The "<code class="literal">orientation</code>" property</h3>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2624759"></a><h3>
<a name="ExoIconBar--pixbuf-column"></a>The "<code class="literal">pixbuf-column</code>" property</h3>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2624806"></a><h3>
<a name="ExoIconBar--text-column"></a>The "<code class="literal">text-column</code>" property</h3>
...
<div class="refsect1" lang="en">
<a name="id2624854"></a><h2>Style Properties</h2>
<div class="refsect2" lang="en">
<a name="id2624859"></a><h3>
<a name="ExoIconBar--active-item-border-color"></a>The "<code class="literal">active-item-border-color</code>" style property</h3>
...
<a name="ExoIconBar--active-item-fill-color"></a>The "<code class="literal">active-item-fill-color</code>" style property</h3>
...
<a name="ExoIconBar--active-item-text-color"></a>The "<code class="literal">active-item-text-color</code>" style property</h3>
<pre class="programlisting">  "active-item-text-color" GdkColor              : Read</pre>
<p>Active item text color.</p>
</div>
<hr>
<div class="refsect2" lang="en">
<a name="id2624952"></a><h3>
<a name="ExoIconBar--cursor-item-border-color"></a>The "<code class="literal">cursor-item-border-color</code>" style property</h3>
<pre class="programlisting">  "cursor-item-border-color" GdkColor              : Read</pre>
<p>Cursor item border color.</p>
</div>
<hr>
<div class="refsect2" lang="en">
<a name="id2624983"></a><h3>
<a name="ExoIconBar--cursor-item-fill-color"></a>The "<code class="literal">cursor-item-fill-color</code>" style property</h3>
<pre class="programlisting">  "cursor-item-fill-color" GdkColor              : Read</pre>
<p>Cursor item fill color.</p>
</div>
<hr>
<div class="refsect2" lang="en">
<a name="id2625014"></a><h3>
<a name="ExoIconBar--cursor-item-text-color"></a>The "<code class="literal">cursor-item-text-color</code>" style property</h3>
<pre class="programlisting">  "cursor-item-text-color" GdkColor              : Read</pre>
<p>Cursor item text color.</p>
</div>
</div>
<div class="refsect1" lang="en">
<a name="id2625046"></a><h2>Signals</h2>
<div class="refsect2" lang="en">
<a name="id2625051"></a><h3>
<a name="ExoIconBar-selection-changed"></a>The "selection-changed" signal</h3>
<pre class="programlisting">void        user_function                  (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
...
<td>
<span class="term"><em class="parameter"><code>icon_bar</code></em>&#160;:</span></td>
<td> The <a href="ExoIconBar.html" title="ExoIconBar"><span class="type">ExoIconBar</span></a>.
</td>
</tr>
<tr>
<td>
...
<a name="ExoIconBar-set-scroll-adjustments"></a>The "set-scroll-adjustments" signal</h3>
<pre class="programlisting">void        user_function                  (<a href="ExoIconBar.html" title="ExoIconBar">ExoIconBar</a> *icon_bar,
                                            GtkAdjustment *hadjustment,
                                            GtkAdjustment *vadjustment,
                                            gpointer user_data);</pre>
<p>
Used internally to make the <a href="ExoIconBar.html" title="ExoIconBar"><span class="type">ExoIconBar</span></a> scrollable.</p>
<p>
...
<div class="refsect1" lang="en">
<a name="id2625315"></a><h2>See Also</h2>
<p>
...
<td align="left"><a accesskey="p" href="ExoEllipsizedLabel.html"><b>&lt;&lt;&#160;ExoEllipsizedLabel</b></a></td>
<td align="right"><a accesskey="n" href="ExoIconView.html"><b>ExoIconView&#160;&gt;&gt;</b></a></td>
</tr></table>
</body>
</html>
