...
<a name="id2616121"></a><h2>Stability Level</h2>
...
<div class="refsect1" lang="en">
<a name="id2617172"></a><h2>Object Hierarchy</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2617189"></a><h2>Prerequisites</h2>
<p>
ThunarxMenuProvider requires
 GObject.</p>
</div>
<div class="refsect1" lang="en">
<a name="id2617204"></a><h2>Description</h2>
<p>
...
<div class="example">
<a name="id2617309"></a><p class="title"><b>Example&#160;5.&#160;Menu provider example</b></p>
...
<div class="refsect1" lang="en">
<a name="id2617481"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2617486"></a><h3>
<a name="ThunarxMenuProviderIface"></a>ThunarxMenuProviderIface</h3>
<a class="indexterm" name="id2617495"></a><pre class="programlisting">typedef struct {
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617565"></a><h3>
<a name="ThunarxMenuProvider-struct"></a>ThunarxMenuProvider</h3>
<a class="indexterm" name="id2617574"></a><pre class="programlisting">typedef struct _ThunarxMenuProvider ThunarxMenuProvider;</pre>
<p>
  Menu provider type.
</p>
</div>
<hr>
<div class="refsect2" lang="en">
<a name="id2617589"></a><h3>
<a name="thunarx-menu-provider-get-file-actions"></a>thunarx_menu_provider_get_file_actions ()</h3>
<a class="indexterm" name="id2617601"></a><pre class="programlisting">GList*      thunarx_menu_provider_get_file_actions
                                            (<a href="ThunarxMenuProvider.html" title="ThunarxMenuProvider">ThunarxMenuProvider</a> *provider,
                                             GtkWidget *window,
                                             GList *files);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617788"></a><h3>
<a name="thunarx-menu-provider-get-folder-actions"></a>thunarx_menu_provider_get_folder_actions ()</h3>
<a class="indexterm" name="id2617800"></a><pre class="programlisting">GList*      thunarx_menu_provider_get_folder_actions
                                            (<a href="ThunarxMenuProvider.html" title="ThunarxMenuProvider">ThunarxMenuProvider</a> *provider,
                                             GtkWidget *window,
...
<div class="refsect1" lang="en">
<a name="id2618050"></a><h2>See Also</h2>
<p>
