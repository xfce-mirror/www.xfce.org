...
<a name="id2554968"></a><h2>Stability Level</h2>
...
<div class="refsect1" lang="en">
<a name="id2602498"></a><h2>Description</h2>
<p>
...
<div class="refsect1" lang="en">
<a name="id2602507"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2602513"></a><h3>
<a name="thunarx-major-version"></a>thunarx_major_version</h3>
<a class="indexterm" name="id2602521"></a><pre class="programlisting">extern const guint thunarx_major_version;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2602577"></a><h3>
<a name="thunarx-minor-version"></a>thunarx_minor_version</h3>
<a class="indexterm" name="id2602585"></a><pre class="programlisting">extern const guint thunarx_minor_version;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2602641"></a><h3>
<a name="thunarx-micro-version"></a>thunarx_micro_version</h3>
<a class="indexterm" name="id2602649"></a><pre class="programlisting">extern const guint thunarx_micro_version;
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2602705"></a><h3>
<a name="thunarx-check-version"></a>thunarx_check_version ()</h3>
<a class="indexterm" name="id2602713"></a><pre class="programlisting">const gchar* thunarx_check_version          (guint required_major,
                                             guint required_minor,
...
<div class="example">
<a name="id2602877"></a><p class="title"><b>Example&#160;3.&#160;Checking the runtime version of the Thunar Extension library</b></p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2602954"></a><h3>
<a name="THUNARX-MAJOR-VERSION:CAPS"></a>THUNARX_MAJOR_VERSION</h3>
<a class="indexterm" name="id2602963"></a><pre class="programlisting">#define THUNARX_MAJOR_VERSION 0
</pre>
<p>
...
<a class="indexterm" name="id2602995"></a><pre class="programlisting">#define THUNARX_MINOR_VERSION 2
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2603086"></a><h3>
<a name="THUNARX-MICRO-VERSION:CAPS"></a>THUNARX_MICRO_VERSION</h3>
<a class="indexterm" name="id2603095"></a><pre class="programlisting">#define THUNARX_MICRO_VERSION 1
</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2603118"></a><h3>
<a name="THUNARX-CHECK-VERSION:CAPS"></a>THUNARX_CHECK_VERSION()</h3>
<a class="indexterm" name="id2603127"></a><pre class="programlisting">#define     THUNARX_CHECK_VERSION(major,minor,micro)</pre>
<p>
...
<div class="example">
<a name="id2603162"></a><p class="title"><b>Example&#160;4.&#160;Checking the version of the Thunar Extension library</b></p>
<pre class="programlisting">
