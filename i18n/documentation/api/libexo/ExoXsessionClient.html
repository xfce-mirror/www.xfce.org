...
<link rel="next" href="exo-tools.html" title="Part&#160;VI.&#160;Tools">
...
<td valign="top">
<h2><span class="refentrytitle">ExoXsessionClient</span></h2>
...
<a name="id2680358"></a><h2>Object Hierarchy</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2680375"></a><h2>Properties</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2680413"></a><h2>Signal Prototypes</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2680448"></a><h2>Description</h2>
<p>
...
<div class="example">
<a name="id2680470"></a><p class="title"><b>Example&#160;4.&#160;Texteditor with <span class="structname">ExoXsessionClient</span></b></p>
...
<div class="refsect1" lang="en">
<a name="id2680647"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2680652"></a><h3>
<a name="ExoXsessionClient-struct"></a>ExoXsessionClient</h3>
<a class="indexterm" name="id2680661"></a><pre class="programlisting">typedef struct _ExoXsessionClient ExoXsessionClient;</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2680676"></a><h3>
<a name="exo-xsession-client-new-with-group"></a>exo_xsession_client_new_with_group ()</h3>
<a class="indexterm" name="id2680688"></a><pre class="programlisting"><a href="ExoXsessionClient.html" title="ExoXsessionClient">ExoXsessionClient</a>* exo_xsession_client_new_with_group
                                            (GdkWindow *leader);</pre>
<p>
...
<tr>
<td>
<span class="term"><em class="parameter"><code>leader</code></em>&#160;:</span></td>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2680762"></a><h3>
<a name="exo-xsession-client-get-group"></a>exo_xsession_client_get_group ()</h3>
<a class="indexterm" name="id2680772"></a><pre class="programlisting">GdkWindow*  exo_xsession_client_get_group   (<a href="ExoXsessionClient.html" title="ExoXsessionClient">ExoXsessionClient</a> *client);</pre>
<p>
</p>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2680844"></a><h3>
<a name="exo-xsession-client-set-group"></a>exo_xsession_client_set_group ()</h3>
<a class="indexterm" name="id2680854"></a><pre class="programlisting">void        exo_xsession_client_set_group   (<a href="ExoXsessionClient.html" title="ExoXsessionClient">ExoXsessionClient</a> *client,
                                             GdkWindow *leader);</pre>
<p>
</p>
<p>
...
<td>
<span class="term"><em class="parameter"><code>leader</code></em>&#160;:</span></td>
<td> The client leader window of a group or <code class="literal">NULL</code>.
</td>
</tr>
</tbody>
</table></div>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2680931"></a><h3>
<a name="exo-xsession-client-get-restart-command"></a>exo_xsession_client_get_restart_command ()</h3>
<a class="indexterm" name="id2680942"></a><pre class="programlisting">gboolean    exo_xsession_client_get_restart_command
                                            (<a href="ExoXsessionClient.html" title="ExoXsessionClient">ExoXsessionClient</a> *client,
                                             gchar ***argv,
                                             gint *argc);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2681093"></a><h3>
<a name="exo-xsession-client-set-restart-command"></a>exo_xsession_client_set_restart_command ()</h3>
<a class="indexterm" name="id2681173"></a><pre class="programlisting">void        exo_xsession_client_set_restart_command
                                            (<a href="ExoXsessionClient.html" title="ExoXsessionClient">ExoXsessionClient</a> *client,
                                             gchar **argv,
                                             gint argc);</pre>
<p>
...
<div class="refsect1" lang="en">
<a name="id2681335"></a><h2>Properties</h2>
<div class="refsect2" lang="en">
<a name="id2681340"></a><h3>
<a name="ExoXsessionClient--group"></a>The "<code class="literal">group</code>" property</h3>
<pre class="programlisting">  "group"                GdkWindow             : Read / Write</pre>
<p>
</p>
<p>
...
<div class="refsect1" lang="en">
<a name="id2681473"></a><h2>Signals</h2>
<div class="refsect2" lang="en">
<a name="id2681478"></a><h3>
<a name="ExoXsessionClient-save-yourself"></a>The "save-yourself" signal</h3>
<pre class="programlisting">void        user_function                  (<a href="ExoXsessionClient.html" title="ExoXsessionClient">ExoXsessionClient</a> *client,
...
<td align="left"><a accesskey="p" href="exo-Miscellaneous-Utility-Functions.html"><b>&lt;&lt;&#160;Miscellaneous Utility Functions</b></a></td>
<td align="right"><a accesskey="n" href="exo-tools.html"><b>Part&#160;VI.&#160;Tools&#160;&gt;&gt;</b></a></td>
</tr></table>
</body>
</html>
