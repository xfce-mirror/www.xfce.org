...
GList*      <a href="ThunarVfsUserManager.html#thunar-vfs-user-manager-get-all-groups">thunar_vfs_user_manager_get_all_groups</a>
                                            (<a href="ThunarVfsUserManager.html" title="ThunarVfsUserManager">ThunarVfsUserManager</a> *manager);
...
<a name="id2637171"></a><h2>Object Hierarchy</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2637188"></a><h2>Description</h2>
<p>

</p>
</div>
<div class="refsect1" lang="en">
<a name="id2637197"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2637203"></a><h3>
<a name="ThunarVfsUserManager-struct"></a>ThunarVfsUserManager</h3>
<a class="indexterm" name="id2637211"></a><pre class="programlisting">typedef struct _ThunarVfsUserManager ThunarVfsUserManager;</pre>
<p>
...
<a class="indexterm" name="id2637238"></a><pre class="programlisting"><a href="ThunarVfsUserManager.html" title="ThunarVfsUserManager">ThunarVfsUserManager</a>* thunar_vfs_user_manager_get_default
                                            (void);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2637297"></a><h3>
<a name="thunar-vfs-user-manager-get-group-by-id"></a>thunar_vfs_user_manager_get_group_by_id ()</h3>
<a class="indexterm" name="id2637308"></a><pre class="programlisting"><a href="ThunarVfsGroup.html" title="ThunarVfsGroup">ThunarVfsGroup</a>* thunar_vfs_user_manager_get_group_by_id
                                            (<a href="ThunarVfsUserManager.html" title="ThunarVfsUserManager">ThunarVfsUserManager</a> *manager,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2637529"></a><h3>
<a name="thunar-vfs-user-manager-get-user-by-id"></a>thunar_vfs_user_manager_get_user_by_id ()</h3>
<a class="indexterm" name="id2637541"></a><pre class="programlisting"><a href="ThunarVfsUser.html" title="ThunarVfsUser">ThunarVfsUser</a>* thunar_vfs_user_manager_get_user_by_id
                                            (<a href="ThunarVfsUserManager.html" title="ThunarVfsUserManager">ThunarVfsUserManager</a> *manager,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2637693"></a><h3>
<a name="thunar-vfs-user-manager-get-all-groups"></a>thunar_vfs_user_manager_get_all_groups ()</h3>
<a class="indexterm" name="id2637705"></a><pre class="programlisting">GList*      thunar_vfs_user_manager_get_all_groups
                                            (<a href="ThunarVfsUserManager.html" title="ThunarVfsUserManager">ThunarVfsUserManager</a> *manager);</pre>
<p>
Returns the list of all <a href="ThunarVfsGroup.html" title="ThunarVfsGroup"><span class="type">ThunarVfsGroup</span></a>s in the system
that are known to the <em class="parameter"><code>manager</code></em>.
</p>
<p>
...
<td>
<span class="term"><span class="emphasis"><em>Returns</em></span>&#160;:</span></td>
<td> the list of all groups known to the <em class="parameter"><code>manager</code></em>.
</td>
</tr>
</tbody>
</table></div>
