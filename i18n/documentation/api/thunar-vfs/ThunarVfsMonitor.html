...
<p>ThunarVfsMonitor &#8212; Portable file system monitoring class.</p>
</td>
...
<a name="id2616585"></a><h2>Object Hierarchy</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2616670"></a><h2>Description</h2>
<p>

</p>
</div>
<div class="refsect1" lang="en">
<a name="id2616680"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2616685"></a><h3>
<a name="ThunarVfsMonitor-struct"></a>ThunarVfsMonitor</h3>
<a class="indexterm" name="id2616694"></a><pre class="programlisting">typedef struct _ThunarVfsMonitor ThunarVfsMonitor;</pre>
<p>
  The <a href="ThunarVfsMonitor.html#ThunarVfsMonitor-struct"><span class="type">ThunarVfsMonitor-struct</span></a> contains private data only, and should
  be accessed using the functions below.
</p>
</div>
<hr>
<div class="refsect2" lang="en">
<a name="id2616715"></a><h3>
<a name="ThunarVfsMonitorEvent"></a>enum ThunarVfsMonitorEvent</h3>
<a class="indexterm" name="id2616724"></a><pre class="programlisting">typedef enum
{
...
<hr>
<div class="refsect2" lang="en">
<a name="id2616801"></a><h3>
<a name="ThunarVfsMonitorHandle"></a>ThunarVfsMonitorHandle</h3>
<a class="indexterm" name="id2616809"></a><pre class="programlisting">typedef struct _ThunarVfsMonitorHandle ThunarVfsMonitorHandle;</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2616834"></a><h3>
<a name="ThunarVfsMonitorCallback"></a>ThunarVfsMonitorCallback ()</h3>
<a class="indexterm" name="id2616842"></a><pre class="programlisting">void        (*ThunarVfsMonitorCallback)     (<a href="ThunarVfsMonitor.html" title="ThunarVfsMonitor">ThunarVfsMonitor</a> *monitor,
                                             <a href="ThunarVfsMonitor.html#ThunarVfsMonitorHandle">ThunarVfsMonitorHandle</a> *handle,
                                             <a href="ThunarVfsMonitor.html#ThunarVfsMonitorEvent">ThunarVfsMonitorEvent</a> event,
                                             <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *handle_path,
                                             <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *event_path,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617116"></a><h3>
<a name="thunar-vfs-monitor-get-default"></a>thunar_vfs_monitor_get_default ()</h3>
<a class="indexterm" name="id2617126"></a><pre class="programlisting"><a href="ThunarVfsMonitor.html" title="ThunarVfsMonitor">ThunarVfsMonitor</a>* thunar_vfs_monitor_get_default
                                            (void);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617185"></a><h3>
<a name="thunar-vfs-monitor-add-directory"></a>thunar_vfs_monitor_add_directory ()</h3>
<a class="indexterm" name="id2617196"></a><pre class="programlisting"><a href="ThunarVfsMonitor.html#ThunarVfsMonitorHandle">ThunarVfsMonitorHandle</a>* thunar_vfs_monitor_add_directory
                                            (<a href="ThunarVfsMonitor.html" title="ThunarVfsMonitor">ThunarVfsMonitor</a> *monitor,
                                             <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path,
                                             <a href="ThunarVfsMonitor.html#ThunarVfsMonitorCallback">ThunarVfsMonitorCallback</a> callback,
                                             gpointer user_data);</pre>
...
<em class="parameter"><code>path</code></em> refers or any of the files within the directory.
</p>
<p>
The returned <a href="ThunarVfsMonitor.html#ThunarVfsMonitorHandle"><span class="type">ThunarVfsMonitorHandle</span></a> can be used to remove
the <em class="parameter"><code>path</code></em> from <em class="parameter"><code>monitor</code></em> using <a href="ThunarVfsMonitor.html#thunar-vfs-monitor-remove"><code class="function">thunar_vfs_monitor_remove()</code></a>.</p>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617393"></a><h3>
<a name="thunar-vfs-monitor-add-file"></a>thunar_vfs_monitor_add_file ()</h3>
<a class="indexterm" name="id2617401"></a><pre class="programlisting"><a href="ThunarVfsMonitor.html#ThunarVfsMonitorHandle">ThunarVfsMonitorHandle</a>* thunar_vfs_monitor_add_file
                                            (<a href="ThunarVfsMonitor.html" title="ThunarVfsMonitor">ThunarVfsMonitor</a> *monitor,
                                             <a href="thunar-vfs-ThunarVfsPath.html#ThunarVfsPath">ThunarVfsPath</a> *path,
                                             <a href="ThunarVfsMonitor.html#ThunarVfsMonitorCallback">ThunarVfsMonitorCallback</a> callback,
                                             gpointer user_data);</pre>
...
<em class="parameter"><code>path</code></em> refers.
</p>
<p>
The returned <a href="ThunarVfsMonitor.html#ThunarVfsMonitorHandle"><span class="type">ThunarVfsMonitorHandle</span></a> can be used to remove
the <em class="parameter"><code>path</code></em> from <em class="parameter"><code>monitor</code></em> using <a href="ThunarVfsMonitor.html#thunar-vfs-monitor-remove"><code class="function">thunar_vfs_monitor_remove()</code></a>.</p>
...
<a class="indexterm" name="id2617604"></a><pre class="programlisting">void        thunar_vfs_monitor_remove       (<a href="ThunarVfsMonitor.html" title="ThunarVfsMonitor">ThunarVfsMonitor</a> *monitor,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617833"></a><h3>
<a name="thunar-vfs-monitor-feed"></a>thunar_vfs_monitor_feed ()</h3>
<a class="indexterm" name="id2617842"></a><pre class="programlisting">void        thunar_vfs_monitor_feed         (<a href="ThunarVfsMonitor.html" title="ThunarVfsMonitor">ThunarVfsMonitor</a> *monitor,
                                             <a href="ThunarVfsMonitor.html#ThunarVfsMonitorEvent">ThunarVfsMonitorEvent</a> event,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2617961"></a><h3>
<a name="thunar-vfs-monitor-wait"></a>thunar_vfs_monitor_wait ()</h3>
<a class="indexterm" name="id2617970"></a><pre class="programlisting">void        thunar_vfs_monitor_wait         (<a href="ThunarVfsMonitor.html" title="ThunarVfsMonitor">ThunarVfsMonitor</a> *monitor);</pre>
<p>
