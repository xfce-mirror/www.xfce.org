...
<a name="id2602423"></a><h2>Stability Level</h2>
...
>ThunarVfsInfo</a>* <a href="ThunarxFileInfo.html#thunarx-file-info-get-vfs-info">thunarx_file_info_get_vfs_info</a>
                                            (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);
void        <a href="ThunarxFileInfo.html#thunarx-file-info-changed">thunarx_file_info_changed</a>       (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);
void        <a href="ThunarxFileInfo.html#thunarx-file-info-renamed">thunarx_file_info_renamed</a>       (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);
#define     <a href="ThunarxFileInfo.html#THUNARX-TYPE-FILE-INFO-LIST:CAPS">THUNARX_TYPE_FILE_INFO_LIST</a>
...
<div class="refsect1" lang="en">
<a name="id2604509"></a><h2>Object Hierarchy</h2>
<pre class="synopsis">
...
<div class="refsect1" lang="en">
<a name="id2604526"></a><h2>Prerequisites</h2>
<p>
ThunarxFileInfo requires
 GObject.</p>
</div>
<div class="refsect1" lang="en">
<a name="id2604541"></a><h2>Description</h2>
<p>
...
<div class="refsect1" lang="en">
<a name="id2604556"></a><h2>Details</h2>
<div class="refsect2" lang="en">
<a name="id2604562"></a><h3>
<a name="ThunarxFileInfoIface"></a>ThunarxFileInfoIface</h3>
<a class="indexterm" name="id2604570"></a><pre class="programlisting">typedef struct {
  /* virtual methods */
...
<tr>
<td>
<span class="term"><em class="structfield"><code>get_vfs_info</code></em>&#160;()</span></td>
<td>See <a href="ThunarxFileInfo.html#thunarx-file-info-get-vfs-info"><code class="function">thunarx_file_info_get_vfs_info()</code></a>.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="structfield"><code>changed</code></em>&#160;()</span></td>
<td>See <a href="ThunarxFileInfo.html#thunarx-file-info-changed"><code class="function">thunarx_file_info_changed()</code></a>.
</td>
</tr>
<tr>
<td>
<span class="term"><em class="structfield"><code>renamed</code></em>&#160;()</span></td>
<td>See <a href="ThunarxFileInfo.html#thunarx-file-info-renamed"><code class="function">thunarx_file_info_renamed()</code></a>.
...
<hr>
<div class="refsect2" lang="en">
<a name="id2604881"></a><h3>
<a name="ThunarxFileInfo-struct"></a>ThunarxFileInfo</h3>
<a class="indexterm" name="id2604889"></a><pre class="programlisting">typedef struct _ThunarxFileInfo ThunarxFileInfo;</pre>
<p>
...
<a class="indexterm" name="id2604913"></a><pre class="programlisting">gchar*      thunarx_file_info_get_name      (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605145"></a><h3>
<a name="thunarx-file-info-get-uri"></a>thunarx_file_info_get_uri ()</h3>
<a class="indexterm" name="id2605154"></a><pre class="programlisting">gchar*      thunarx_file_info_get_uri       (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605248"></a><h3>
<a name="thunarx-file-info-get-parent-uri"></a>thunarx_file_info_get_parent_uri ()</h3>
<a class="indexterm" name="id2605259"></a><pre class="programlisting">gchar*      thunarx_file_info_get_parent_uri
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605367"></a><h3>
<a name="thunarx-file-info-get-uri-scheme"></a>thunarx_file_info_get_uri_scheme ()</h3>
<a class="indexterm" name="id2605379"></a><pre class="programlisting">gchar*      thunarx_file_info_get_uri_scheme
                                            (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);</pre>
<p>
...
<a class="indexterm" name="id2605479"></a><pre class="programlisting">gchar*      thunarx_file_info_get_mime_type (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605580"></a><h3>
<a name="thunarx-file-info-has-mime-type"></a>thunarx_file_info_has_mime_type ()</h3>
<a class="indexterm" name="id2605590"></a><pre class="programlisting">gboolean    thunarx_file_info_has_mime_type (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info,
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605746"></a><h3>
<a name="thunarx-file-info-is-directory"></a>thunarx_file_info_is_directory ()</h3>
<a class="indexterm" name="id2605755"></a><pre class="programlisting">gboolean    thunarx_file_info_is_directory  (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2605900"></a><h3>
<a name="thunarx-file-info-get-vfs-info"></a>thunarx_file_info_get_vfs_info ()</h3>
<a class="indexterm" name="id2605910"></a><pre class="programlisting"><a
href="../thunar-vfs/thunar-vfs-ThunarVfsInfo.html#ThunarVfsInfo"
>ThunarVfsInfo</a>* thunarx_file_info_get_vfs_info
                                            (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);</pre>
<p>
Returns the <a
href="../thunar-vfs/thunar-vfs-ThunarVfsInfo.html#ThunarVfsInfo"
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606051"></a><h3>
<a name="thunarx-file-info-changed"></a>thunarx_file_info_changed ()</h3>
<a class="indexterm" name="id2606059"></a><pre class="programlisting">void        thunarx_file_info_changed       (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606189"></a><h3>
<a name="thunarx-file-info-renamed"></a>thunarx_file_info_renamed ()</h3>
<a class="indexterm" name="id2606198"></a><pre class="programlisting">void        thunarx_file_info_renamed       (<a href="ThunarxFileInfo.html" title="ThunarxFileInfo">ThunarxFileInfo</a> *file_info);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606263"></a><h3>
<a name="THUNARX-TYPE-FILE-INFO-LIST:CAPS"></a>THUNARX_TYPE_FILE_INFO_LIST</h3>
<a class="indexterm" name="id2606274"></a><pre class="programlisting">#define THUNARX_TYPE_FILE_INFO_LIST (thunarx_file_info_list_get_type ())
</pre>
<p>
  The <span class="type">GType</span> for a boxed type holding a <span class="type">GList</span> of <a href="ThunarxFileInfo.html" title="ThunarxFileInfo"><span class="type">ThunarxFileInfo</span></a>s.
  See <a href="ThunarxFileInfo.html#thunarx-file-info-list-copy"><code class="function">thunarx_file_info_list_copy()</code></a> and <a href="ThunarxFileInfo.html#thunarx-file-info-list-free"><code class="function">thunarx_file_info_list_free()</code></a>.
</p>
</div>
<hr>
<div class="refsect2" lang="en">
<a name="id2606393"></a><h3>
<a name="thunarx-file-info-list-copy"></a>thunarx_file_info_list_copy ()</h3>
<a class="indexterm" name="id2606402"></a><pre class="programlisting">GList*      thunarx_file_info_list_copy     (GList *file_infos);</pre>
<p>
...
<hr>
<div class="refsect2" lang="en">
<a name="id2606481"></a><h3>
<a name="thunarx-file-info-list-free"></a>thunarx_file_info_list_free ()</h3>
<a class="indexterm" name="id2606489"></a><pre class="programlisting">void        thunarx_file_info_list_free     (GList *file_infos);</pre>
<p>
