				...
				<div id="header-right">
					...
					<div id="header-search">
						...
						<form method="get" action="http://ww.google.com/search" name="g">
							<input type="text" class="field" name="q" id="q" onfocus="if(this.value==this.defaultValue ) this.value='';" onblur="if(this.value=='') this.value=this.defaultValue;" value="Search..." />
