<div id="front-intro">
    <div id="front-right">
        <div id="front-download">
            <div class="link">
                <h2><a href="/download/" title="Faça download do Xfce 4.4.2 agora!">Download do Xfce 4.4.2</a></h2>
            </div>
            <div class="notes">
                <p><a href="/documentation/changelogs/4.4.2" title="Leia os Registos de Mudanças">Registos de Mudanças</a><span class="grey"> | </span><a href="/about/tour" title="O que há de novo no Xfce 4.4">Tour</a></p>
            </div>
        </div>
    </div>
    <div id="front-intro-about">
        ...
        <p>Xfce 4.4 incorpora a filosofia tradicional de reutilização e modularidade do UNIX. Consiste num número de componentes que juntos fornecem a funcionalidade completa para o ambiente de desktop. São empacotados separadamente e pode seleccionar os pacotes disponíveis para criar o melhor ambiente de trabalho personalizado.</p>
    ...
    <div id="front-blog">
        <div id="front-blog-content">
            ...
            <ul>
                ...
                <li><a href="http://bugzilla.xfce.org" title="Reportar uma falha (Nova Janela)" target="_blank" class="external">Relatar uma falha</a></li>
