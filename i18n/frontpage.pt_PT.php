<div id="front-intro">
    <div id="front-right">
        <div id="front-download">
            <div class="link">
                <h2><a href="/download/" title="Faça download do Xfce 4.4.1 agora!">Download do Xfce 4.4.1</a></h2>
            </div>
            <div class="notes">
                <p><a href="/documentation/changelogs/4.4.1" title="Leia os Registos de Mudanças">Registos de Mudanças</a><span class="grey"> | </span><a href="/about/tour" title="O que há de novo no Xfce 4.4">Tour</a></p>
            </div>
        </div>
    </div>
