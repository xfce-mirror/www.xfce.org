...
<p>Se quiser compilar o Xfce a partir do código fonte, pode fazer o download das tarballs de uma das versões do Xfce da nossa <a href="/download">página de download</a>,  ou usar uma versão de desenvolvimento, a partir da subversion (apenas para aventureiros).
...
<h3>Snapshots desenvolvidos diariamente</h3>
<p>Se não quiser testar a versão de desenvolvimento do Xfce ou não tem experiência em compilar a partir do SVN, pode fazer o download dos snapshots diários de desenvolvimento  <a href="http://foo-projects.org/~elangelo/xfce-snapshots/" target="_blank">aqui</a>.</p>
<h2>Construir os módulos</h2>
<p>Se fez o download das tarballs, precisa de descompactar antes de continuar.</p>
...
<p>Para construir os módulos das tarballs execute:</p>
