...
<table border="0" cellspacing="10" cellpadding="0">
	<tr>
		...
		<td>Xubuntu is een Linux distributie gebaseerd op Ubuntu, alleen gebuikt Xubuntu de lichte Xfce bureaublad omgeving en is het geoptimaliseerd voor langzamere computers. Bij deze distributie wordt er zoveel mogelijk gebruik gemaakt van GTK+ programma's.</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
...
<table border="0" cellspacing="10" cellpadding="0">
	<tr>
		...
		<td>Xfld - 'Xfce live demo' - is een live CD waarmee de laatste versie van de Xfce bureaublad omgeving kan worden geprobeerd. Het is gebaseerd op Ubuntu en kan volledig vanaf CD worden gedraait.</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
...
<table border="0" cellspacing="10" cellpadding="0">
	<tr>
		...
		<td>Lunar Linux is een distributie die direkt de broncode van het programma gebruikt (source-based). Ondanks dat Lunar geen hoofd bureaublad omgeving heeft, heeft het wel perfecte ondersteuning voor Xfce, voornamelijk omdat een aantal Xfce ontwikkelaars ook als Lunar Linux ontwikelaar actief zijn.<br />
Verder draaien alle Xfce servers op Lunar Linux!</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
