...
<p>La plupart des distributions linux contiennent Xfce. Si vous voulez la nouvelle version ou si vous voulez compiler Xfce depuis le départ, vous trouverez les paquets ci-dessous. Vous pouvez aussi jeter un oeil aux distributions Xfce <a href="/download/distros">ici</a>.</p>

<h2 id="source">Code source</h2>
<p>Tous les modules Xfce sont disponibles dans un fichier archive depuis notre dépôt SourceForge et différents autres mirroirs (en un fichier archive <em>ou</em> plusieurs fichiers séparés :</p>
