<div id="front-intro">
    <div id="front-right">
        <div id="front-download">
            <div class="link">
                <h2><a href="/download/" title="Faça download do Xfce 4.4.2 agora!">Baixe o Xfce 4.4.2</a></h2>
            </div>
            <div class="notes">
                <p><a href="/documentation/changelogs/4.4.2" title="Leia os Registros de Mudanças">Registros de Mudanças</a><span class="grey"> | </span><a href="/about/tour" title="O que há de novo no Xfce 4.4">Tur</a></p>
            </div>
        </div>
    </div>
