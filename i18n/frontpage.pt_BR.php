<div id="front-intro">
    <div id="front-right">
        <div id="front-download">
            <div class="link">
                <h2><a href="/download/" title="Faça download do Xfce 4.4.3 agora!">Baixe o Xfce 4.4.3</a></h2>
            </div>
            <div class="notes">
                <p><a href="/documentation/changelogs/4.4.3" title="Leia os Registros de Mudanças">Registros de Mudanças</a><span class="grey"> | </span><a href="/about/tour" title="O que há de novo no Xfce 4.4">Tur</a></p>
            </div>
        </div>
    </div>
    <div id="front-intro-about">
        ...
        <p>Xfce 4.4 incorpora a filosofia tradicional de reutilização e modularidade do UNIX. Ele consiste de um número de componentes que juntos fornecem a funcionalidade completa para o ambiente de desktop. Eles são empacotados separadamente e você pode selecionar os pacotes disponíveis para criar o melhor ambiente de trabalho personalizado.</p>
    ...
    <div id="front-blog">
        <div id="front-blog-content">
            ...
            <ul>
                ...
                <li><a href="http://forum.xfce.org" target="_blank" title="Fórum do Xfce (Nova Janela)" class="external">Fórum do Xfce</a></li>
                <li><a href="http://bugzilla.xfce.org" title="Relatar uma falha (Nova Janela)" target="_blank" class="external">Relatar uma falha</a></li>
                <li><a href="http://wiki.xfce.org" title="Wiki do Xfce (Nova Janela)" target="_blank" class="external">Wiki do Xfce</a></li>
