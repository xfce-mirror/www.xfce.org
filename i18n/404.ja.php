...
<h3>残念ながら、要求されたページまたはファイルはこのサーバー上では見つかりませんでした。</h3>
...
<ul>
	...
	<li>戻るをクリックして他のリンクを試してみてください。</li>
	<li>Xfceのウェブサイト上にある情報を見つけ出すために、上にある検索フォームに言葉を入れてください。</li>
</ul>

<p>必要なときは、検索を補助したり問題を報告するために<a href="mailto:webmaster@xfce.org">ウェブマスターに問い合わせることができます。</a>
