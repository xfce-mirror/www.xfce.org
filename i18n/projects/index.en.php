...
<table width="99%" border="0" cellspacing="10" cellpadding="0">
    ...
    <td width="48" valign="top"><img src="../../images/projects/xfdesktop.png" alt="xfdesktop" width="48" height="48" /></td>
    ...
    <tr>
	<td width="48" valign="top"><img src="../../images/projects/xfce4-session.png" alt="xfce4-session" width="48" height="48" /></td>
...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
    ...
    <tr>
	  <td width="48" valign="top"><img src="../../images/projects/xfce4-appfinder.png" alt="xfce4-appfinder" width="48" height="48" />
	...
	<td width="48" valign="top"><img src="../../images/projects/xfce4-mixer.png" alt="xfce4-mixer" width="48" height="48" /></td>
    <td width="33%" valign="top"><h3><a href="/projects/xfce4-mixer/">Volume Control</a></h3>
        <p>A volume control for the panel. It includes a mixer dialog wich supports ALSA, OSS and Sun audio.</p></td>
    <td width="48" valign="top"><img src="../../images/projects/terminal.png" alt="xfce4-terminal" width="48" height="48" /></td>
    ...
    <tr>
      <td width="48" valign="top"><img src="../../images/projects/xarchiver.png" alt="xarchiver" width="48" height="48" /></td>
      <td valign="top"><h3><a href="/projects/xarchiver/">Archive Manager</a></h3>
...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
    ...
    <tr>
      <td width="48" valign="top"><img src="../../images/projects/library.png" alt="xfce4-perl" width="48" height="48" /></td>
      <td width="33%" valign="top"><h3><a href="/projects/xfce4-perl/">Xfce4 Perl </a></h3>
      <p>Xfce4-perl are Xfce bindings for Perl. It also includes bindings for panel plugins. </p></td>
      <td width="48" valign="top"><img src="../../images/projects/library.png" alt="dbh" width="48" height="48" /></td>
      <td width="33%" valign="top"><h3><a href="/projects/dbh/">Disk Based Hashtables</a></h3>
          <p>DBH is a library to create Disk Based Hashtables on POSIX systems.</p></td>
      <td width="48" valign="top">&nbsp;</td>
      <td width="33%" valign="top">&nbsp;</td>
    </tr>
</table>
...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
    <tr>
      <td width="48" valign="top"><img src="../../images/projects/xfce-gtk-engine.png" alt="xfce-gtk-engine" width="48" height="48" /></td>
      ...
      <td width="48" valign="top"><img src="../../images/projects/xfce4-icon-theme.png" alt="xfce4-icon-theme" width="48" height="48" /> </td>
      ...
      <td width="48" valign="top"><img src="/layout/images/spacer.gif" alt="spacer" width="48" height="48" /></td>
