...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
    ...
    <tr>
        ...
        <td width="33%" valign="top">
            ...
            <p>Xfce4-terminal é um emulador de terminal para o xfce4, baseado no vte libs.</p>
        </td>
    </tr>
    <tr>
        <td width="48" valign="top">
        ...
        <td valign="top">
            <h3><a href="http://goodies.xfce.org/projects/applications/ristretto">Image Viewer</a></h3>
...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
    <tr>
        ...
        <td width="33%" valign="top">
            ...
            <p>As bibliotecas do núcleo Xfce são destinadas ao desenvolvimento do desktop, libexo é destinado ao desenvolvimento de aplicações.</p>
        </td>
        <td width="48" valign="top">
