...
<h1>Orage</h1>
<p>Orage提供一个与Xfce桌面环境很好得整合的日历程序。它极具定制性并且拥有日期提醒功能。它通过弹出信息或播放音频文件来进行提醒。通常你每天都会用到这个程序，所以它以守护进程的形式在后台运行。</p>

<h2>外部链接</h2>
<p><a class="external" target="_blank" href="http://www.kolumbus.fi/~w408237/orage/">主页</a></p>
