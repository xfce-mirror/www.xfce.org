...
<table width="99%" border="0" cellspacing="10" cellpadding="0">
	<tr>
		...
		<td width="33%" valign="top">
			...
			<p>Gère le placement des fenêtres des applications à l'écran, fournit les décorations des fenêtres et gère les espaces de travail des bureaux virtuels.</p>
		</td>
		<td width="48" valign="top">
	...
	<tr>
		...
		<td width="33%" valign="top">
		<h3><a href="/projects/xfce-mcs-manager/">Gestionnaire de paramètres</a></h3>
			<p>Le système de configuration de Xfce, il fonctionne en tâche de fond et fournit des informations globales sur les paramètres des composants de Xfce.</p>
		</td>
	</tr>
	<tr>
		<td width="48" valign="top">
...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
	<tr>
		...
		<td width="33%" valign="top">
			...
			<p>InstallIt est l'approche officiel à transformer le fameux installateur Xfce en un gestionnaire d'application et d'installation plus générique. Il est écrit en Python/GTK.</p>
		</td>
		<td width="48" valign="top">
	...
	<tr>
		...
		<td width="33%" valign="top">
			...
			<p>Un simple calendrier avec gestion des rendez-vous.</p>
		</td>
	</tr>
	<tr>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>Un contrôleur du volume pour le panneau. Il inclut une fenêtre de réglages supportant ALSA, OSS et Sun audio.</p>
		</td>
		<td width="48" valign="top">
	...
	<tr>
		...
		<td valign="top">
			<h3><a href="http://goodies.xfce.org/projects/applications/ristretto">Visualiseur d'Images</a></h3>
