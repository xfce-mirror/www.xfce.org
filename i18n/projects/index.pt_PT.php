...
<table width="99%" border="0" cellspacing="10" cellpadding="0">
	<tr>
		...
		<td width="33%" valign="top">
			<h3><a href="/projects/xfwm4/">Gestor de Janela</a></h3>
			<p>Gere o local da janela no ecrã, suporta
			  decorações de janela e gere os espaços de trabalho ou desktops virtuais.</p>
		</td>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>O Xfce 4 panel é parte do Xfce 4 Desktop Environment e
		...
		<td width="33%" valign="top">
			...
			<p>Este programa muda a imagem de fundo e oferece uma janela de menu principal,
			ícones de desktop ou ícones minimizados e uma lista de janelas.</p>
		</td>
	</tr>
	<tr>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>O gestor de sessão controla o início e o encerramento do Ambiente Desktop Xfce.</p>
		</td>
		<td width="48" valign="top">
...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
	<tr>
		...
		<td width="33%" valign="top">
			...
			o Mousepad foi o suporte a impressão, que era difícil para o Leafpad por várias razões.</p>
		</td>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>Terminal é um moderno emulador de terminal para o desktop Unix/Linux - principalmente para o ambiente
			desktop Xfce.</p>
		</td>
	</tr>
	<tr>
		...
		<td width="33%" valign="top">
			...
			<p>Thunar é um novo gestor de ficheiros moderno para o Ambiente Desktop Xfce. Thunar foi feito
			de raíz para ser rápido e fácil de usar.</p>
		</td>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>Xfburn é uma aplicação de gravação frontend que usa o cdrtools (cdrecord, cdrdao,
			mkisofs) para criar e queimar CD's e DVD's.</p>
		</td>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>Uma simples aplicação de calendário com relembretes.</p>
		</td>
	</tr>
	<tr>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>Um controlo de volume para o painel. Inclui um diálogo de mixer que suporta ALSA,
			OSS e Sun audio.</p>
		</td>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<!-- fuzzy <p>Xfce4-terminal é um emulador de terminal para o xfce4, basedo no vte libs.</p> -->
...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
	<tr>
		...
		<td width="33%" valign="top">
			...
			<p>As bibliotecas base do Xfce são alvo do desenvolvimento desktop, libexo é o alvo do desenvolvimento de aplicações.</p>
		</td>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>A Xfce Foundation Classes é um conjunto de classes C++ integradas para desenvolver aplicações
			Xfce em sistemas operativos UNIX-like como o Linux.</p>
		</td>
	</tr>
	<tr>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			...
			<p>Xfce4-perl são ligações Xfce para Perl. Também inclui ligações para panel plugins. </p>
		</td>
		<td width="48" valign="top">
...
<table width="99%" border="0" cellpadding="0" cellspacing="10">
	<tr>
		...
		<td width="33%" valign="top">
			...
			<p>Um motor de temas para GTK2. Não é necessário para o desktop, mas é um bom motor 
			de tema, por isso pode testá-lo.</p>
		</td>
		<td width="48" valign="top">
		...
		<td width="33%" valign="top">
			<h3>Icon Theme</h3>
			<p>Tema de ícones padrão para o Xfce 4. Inclui ícones PNG e SVG</p>
		</td>
		<td width="48" valign="top">
